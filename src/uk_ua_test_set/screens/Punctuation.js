        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content">
              <h1 id="calibre_link-18" class="block_23">
                Punctuation
              </h1>
              <p class="block_24">
              ...
              <h2 id="calibre_link-19" class="block_">
              ...
              <p class="block_24">
                ...
                and should be punctuated accordingly. However, sentences without
                a subject or verb could also be legal in some cases, and are
                especially common in informal speech.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  ...
                  <tr class="tr_2">
                    <td class="td_2">
                      <p class="block_15">Correct: Сьогодні він вдома.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> сьогодні він вдома </i>"
                      </p>
                      <p class="block_16">
                        Explanation: Permitted sentence, includes subject (він)
                        and no verb.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_3">
                    <td class="td_2">
                      <p class="block_15">Correct: Можеш прийти завтра.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> можеш прийти завтра </i>"
                      </p>
                      <p class="block_16">
                        Explanation: Sounds like a whole utterance, possibly an
                        answer to a specific question. The subject pronoun was
                        left out by the speaker.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_2">
                    <td class="td_4">
                      <p class="block_15">Correct: Включи ліхтарик.</p>
                    </td>
                    <td class="td_5">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> включи ліхтарик </i>"
                      </p>
                      <p class="block_16">
                        Explanation: Imperative sentences that serve as commands
                        should be formatted as complete sentences.
                      </p>
                    </td>
                  </tr>
                </tbody>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: з нашими сусідами</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: Йдеш на вечірку завтра?</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Отакої.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">Explanation: interjection</p>
                    </td>
                  </tr>
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: Привіт.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">Explanation: greeting</p>
                    </td>
                  </tr>
                  <tr class="tr_">
                    <td class="td_4">
                      <p class="block_15">Correct: Добре. Хай щастить.</p>
                    </td>
                    <td class="td_5">
                      <p class="block_16">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: як варити картоплю</p>
                      <p class="block_16">Incorrect: Як варити картоплю.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: Океан Ельзи пісні</p>
                      <p class="block_16">Incorrect: Океан Ельзи. Пісні.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      ...
                      <p class="block_16">Incorrect: Слухати музику.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    ...
                    <td class="td_1">
                      <p class="block_16">
                        Explanation: Sentence-initial fragment ends mid-stream.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_">
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">
                        Correct: Я зараз йду до кав'ярні. Я замовлю одне Скільки
                        коштує капучино?
                      </p>
                    </td>
                    <td class="td_3">
                  ...
                  <tr class="tr_">
                    <td class="td_4">
                      <p class="block_15">Correct: їхали додому та після</p>
                    </td>
                    <td class="td_5">
                      <p class="block_16">
              ...
              <p class="block_25"></p>
              <p class="block_24">
                The words "так", "ні", "ото ж", and similar items expressing an
                affirmative or negative answer, should generally be considered
                as complete sentences when on their own.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: Так.</p>
                      <p class="block_16">Incorrect: так.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Рома Сандрека Набрати.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
              ...
              <h2 id="calibre_link-20" class="block_">
                Commas
              </h2>
              <p class="block_25"></p>
              <p class="block_24">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_3">
                    <td class="td_7">
                      <p class="block_15">Correct: Де найближча заправка?</p>
                      <p class="block_16">
                    ...
                    <td class="td_8">
                      <p class="block_16">
                        ...
                        these places, do not use a comma. There are places where
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_7">
                      <p class="block_15">Correct: Буенос Айрес, це де?</p>
                    </td>
                    <td class="td_8">
                      <p class="block_16">Explanation: topic-comment</p>
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    ...
                    <td class="td_1">
                      <p class="block_16">Explanation: adverbial</p>
                    </td>
                  </tr>
                  <tr class="tr_">
                    <td class="td_2">
                    ...
                    <td class="td_3">
                      <p class="block_16">Explanation: introductory clause</p>
                    </td>
                  </tr>
                  <tr class="tr_1">
                    <td class="td_2">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_3">
                    <td class="td_">
                      <p class="block_15">
                        Correct: Дійсно, з батареї відкривався вид майже всього
                        розташування російських військ.
                      </p>
                      <p class="block_16">
                        Incorrect: Дійсно з батареї відкривався вид майже всього
                        розташування російських військ.
                      </p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">Explanation: Discourse word.</p>
                    </td>
                  </tr>
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: Так, я згодна.</p>
                      <p class="block_16">Incorrect: Так я згодна.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">Explanation: Yes/no word.</p>
                    </td>
                  </tr>
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: Вибач, я був неправий.</p>
                      <p class="block_16">Incorrect: Вибач я був неправий</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: Добре, я спробую.</p>
                      <p class="block_16">Incorrect: Добре я спробую.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">Explanation: Yes/no word.</p>
                    </td>
              ...
              <p class="block_25"></p>
              <p class="block_24">
                List of interjections and discourse words that are separated by
                comma.
              </p>
              <div class="calibre1">
                <div class="block_27">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">бач</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">бачиш</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">бачте</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">безперечно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">безсумнівно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">безумовно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">бувало</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">видимо</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">видно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">відома річ</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">власне</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">головне</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">головним чином</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">далебі</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">до речі</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">звичайно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">звісно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">здавалось</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">здається</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">значить</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">зрозуміло</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">кажуть</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">коротко кажучи</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">либонь</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">мабуть</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">між іншим</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">мовляв</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">може</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">можливо</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">навпаки</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">на жаль</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">на мій погляд</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">на нашу думку</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">наприклад</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">нарешті</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">на щастя</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">немає сумніву</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">отже</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">очевидно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">певна річ</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">певно</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">по-перше</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">по-друге</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">правда</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">проте</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">однак</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">сказати б</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">справді</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">щоправда</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">як видимо</span>
                </div>
                <div class="block_29">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">ясна річ</span>
                </div>
              </div>
              <p class="block_25"></p>
              <p class="block_24">
                List of interjections and discourse words that are not separated
                by comma.
              </p>
              <div class="calibre1">
                <div class="block_27">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">адже</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">все-таки</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">все ж таки</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">наче</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">начебто</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">немов</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">немовби</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">ніби</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">нібито</span>
                </div>
                <div class="block_28">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">от</span>
                </div>
                <div class="block_29">
                  <span class="bullet_">●&nbsp;</span>
                  <span class="calibre2">принаймні</span>
                </div>
              </div>
              <p class="block_25"></p>
              <p class="block_24">
                Use commas before tag questions and sentence-final "будь ласка",
                "вибач", "правда", etc.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    ...
                    <td class="td_1">
                      <p class="block_16">Explanation: Tag question.</p>
                    </td>
                  </tr>
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: Тут гарно, правда?</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
                  ...
                  <tr class="tr_1">
                    <td class="td_4">
                      <p class="block_15">Correct: Допоможіть, будь ласка.</p>
                    </td>
                    <td class="td_5">
                      <p class="block_16">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: сяють, як зорі у небі</p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">
                  ...
                  <tr class="tr_1">
                    <td class="td_4">
                      <p class="block_15">Correct: легке, немов пір'я</p>
                    </td>
                    <td class="td_5">
                      <p class="block_16">
              ...
              <p class="block_25"></p>
              <p class="block_24">
                Use commas in lists where members are coordinated, belong to the
                same grammatical category and define the same part of the
                sentence.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    ...
                    <td class="td_1">
                      <p class="block_16">Explanation: list of adjectives</p>
                    </td>
                  </tr>
                  <tr class="tr_3">
                    <td class="td_2">
                      <p class="block_15">
                        Correct: Нам потрібні помідори, картопля, м'ясо і олія.
                      </p>
                      <p class="block_16">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    ...
                    <td class="td_1">
                      <p class="block_16">
                        Explanation: Restrictive modifier. The appositive "Київ"
                        restricts which city the speaker is referring to.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_3">
                  ...
                  <tr class="tr_2">
                    ...
                    <td class="td_3">
                      <p class="block_16">Explanation: Restrictive modifier.</p>
                    </td>
                  </tr>
                  <tr class="tr_3">
                    <td class="td_4">
                    ...
                    <td class="td_5">
                      <p class="block_16">
                        ...
                        non-restrictive and merely adds more information. If it
                        was removed, the sentence would have slightly less
              ...
              <p class="block_24">
                ...
                ("й...й"), "ні...ні" (vані...ані"), "то...то" ("не то...не то"),
                "чи...чи" ("чи то...чи то"), "або...або", separate them with
                commas. Do not put a comma between words that belong to fixed
                phrasal sets, among which are: "і так і сяк", "і туди і сюди",
                "і вдень і вночі", "ні туди ні сюди", "ні сяк ні так", "ні се ні
                те", "ні вдень ні вночі", "ні риба ні м'ясо".
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: Тече вода, та не витікає.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
                        Explanation: Adjectival phrases joined by conjunction
                  ...
                  <tr class="tr_2">
                    ...
                    <td class="td_3">
                      <p class="block_16">
                        ...
                        "і...і". The words "і вдень і вночі" belong to the fixed
                        phrase, thus do not put a comma.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_7">
                      <p class="block_15">Correct: З любов'ю, Тарас</p>
                    </td>
                    <td class="td_8">
                      <p class="block_17"></p>
                    </td>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: Привіт, Олено.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">
                  ...
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: Іване, принеси мені води.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_">
                    <td class="td_4">
                      <p class="block_15">
                        Correct: Здрастуй, моя Наталко, як довго ми не бачилися!
                      </p>
                    </td>
                    <td class="td_5">
                      <p class="block_17"></p>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Ok Google</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: зображення собак</p>
                    </td>
                    <td class="td_3">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: Ok Google, увімкни GPS.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_">
                    <td class="td_4">
                      <p class="block_15">
                        Correct: Ok Google, зустрітися завтра з Іваном о другій
                        годині.
                      </p>
                    </td>
                    <td class="td_5">
              ...
              <h2 id="calibre_link-21" class="block_">
                Intonation marks
              </h2>
              <p class="block_25"></p>
              <p class="block_24">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: Як справи?</p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">
                  ...
                  <tr class="tr_">
                    <td class="td_2">
                      <p class="block_15">Correct: О третій ранку?</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
                  ...
                  <tr class="tr_">
                    <td class="td_4">
                      <p class="block_15">Correct: землетрус на Львівщині</p>
                    </td>
                    <td class="td_5">
                      <p class="block_16">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Ура!</p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">
                  ...
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: Приємно познайомитись.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_16">
                  ...
                  <tr class="tr_1">
                    <td class="td_4">
                      <p class="block_15">Correct: Замовч!</p>
                    </td>
                    <td class="td_5">
                      <p class="block_16">
              ...
              <h2 id="calibre_link-22" class="block_">
                Colon and quotation
              </h2>
              <p class="block_25"></p>
              <p class="block_24">
              ...
              <p class="block_24">
                ...
                is at the beginning or in the middle of a sentence, put a comma
                and a dash after the closing quotation mark.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_4">
                    <td class="td_">
                      ...
                      <p class="block_16">
                        Incorrect: Ганна сказала: "Давай зустрінемось о третій."
                      </p>
                      <p class="block_16">
                    ...
                    <td class="td_1">
                      <p class="block_16">
                        Explanation: No period inside the quotation marks. Put a
                  ...
                  <tr class="tr_4">
                    ...
                    <td class="td_3">
                      <p class="block_16">
                        Explanation: No period inside the quotation marks. Put a
                        question mark after the quotation.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_4">
                    <td class="td_4">
                      <p class="block_15">
                        Correct: "Давай зустрінемось о третій", - сказала Ганна.
                      </p>
                      <p class="block_16">
                        Incorrect: "Давай зустрінемось о третій", сказала Ганна.
                      </p>
                      <p class="block_16">
                    ...
                    <td class="td_5">
                      <p class="block_16">
                        Explanation: No period inside the quotation marks. Put a
                        comma and a dash after the quotation.
                      </p>
                    </td>
                  </tr>
                </tbody>
              ...
              <p class="block_24">
                ...
                before the closing quotation mark unless a question mark follows
                the quote. Do not add excess punctuation. If the quote is in the
                middle of a sentence, put a dash after the closing quotation
                mark.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_4">
                    <td class="td_">
                      <p class="block_15">
                        Correct: Ганна спитала: "Ми можемо зустрітися о третій?"
                      </p>
                      <p class="block_16">
                    ...
                    <td class="td_1">
                      <p class="block_16">
                        Explanation: The quote is a question, so put a question
                        mark inside the quotes. Do not put a period after the
                        quote.
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_2">
                    ...
                    <td class="td_5">
                      <p class="block_16">
                        ...
                        exclamation point inside the quotes. Do not put a period
                        after the quote.
                      </p>
                    </td>
                  </tr>
              ...
              <p class="block_24">
                ...
                comma between the clauses. Use sentence structure and intonation
                to determine whether a quote is direct or indirect.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">
                        Correct: Додай нагадування на завтра о 15:30: зустріч з
                        Олесею.
                      </p>
                    </td>
                    <td class="td_1">
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: що таке білатеральність</p>
                      <p class="block_16">
                  ...
                  <tr class="tr_2">
                    <td class="td_4">
                      ...
                      <p class="block_16">
                        Incorrect: "Казак" читається однаково в обох напрямках.
                      </p>
                    </td>
                    <td class="td_5">
                      <p class="block_17"></p>
              ...
              <h2 id="calibre_link-23" class="block_">
                Other symbols
              </h2>
              <p class="block_25"></p>
              <p class="block_30">
                Apart from the Ukrainian letters and the Latin letters a through
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Це будинок Мар'яни.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_1">
                    <td class="td_4">
                      <p class="block_15">Correct: На подвір'ї росте бур'ян.</p>
                    </td>
                    <td class="td_5">
                      <p class="block_17"></p>
                    </td>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_2">
                    <td class="td_7">
                      <p class="block_15">Correct: рейс Київ-Харків</p>
                      <p class="block_16">Incorrect: рейс Київ - Харків</p>
                      <p class="block_16">Incorrect: рейс Київ Харків</p>
                    </td>
                    <td class="td_8">
                      <p class="block_17"></p>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Він живе бозна-де.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_1">
                    <td class="td_2">
                      <p class="block_15">Correct: Зустрінемось віч-на-віч.</p>
                    </td>
                    <td class="td_3">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_1">
                    <td class="td_4">
                      <p class="block_15">Correct: Кам'янець-Подільський</p>
                    </td>
                    <td class="td_5">
                      <p class="block_17"></p>
                    </td>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Київ - столиця України.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
                  ...
                  <tr class="tr_1">
                    <td class="td_4">
                      <p class="block_15">Correct: Жити - не байдики бити.</p>
                    </td>
                    <td class="td_5">
                      <p class="block_17"></p>
                    </td>
              ...
              <p class="block_24">
                ...
                the omitted words are obvious and can be inferred from context.
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
              ...
              <p class="block_24">
                ...
                followed by a predicate which functions like a definition. Such
                definitions are often preceded by the words "це", "оце", "ось",
                "то", "значить".
              </p>
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_1">
                    <td class="td_">
                      <p class="block_15">Correct: Очі - то зеркало душі.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                    </td>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: Кохаєш її - одружуйся.</p>
                    </td>
                    <td class="td_1">
                      <p class="block_16">
              ...
              <h2 id="calibre_link-24" class="block_">
                Spoken punctuation
              </h2>
              <p class="block_25"></p>
              <p class="block_24">
                ...
                <tbody class="calibre5">
                  <tr class="tr_2">
                    <td class="td_">
                      ...
                      <p class="block_16">Incorrect: Як справи?</p>
                      <p class="block_16">
                    ...
                    <td class="td_1">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> як справи знак питання </i>"
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_">
                    <td class="td_2">
                      ...
                      <p class="block_16">Incorrect: Добре...</p>
                    </td>
                    <td class="td_3">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> добре крапка крапка крапка </i>"
                      </p>
                    </td>
                  </tr>
                  <tr class="tr_2">
                  ...
                  <tr class="tr_2">
                    <td class="td_4">
                      <p class="block_15">Correct: {`{Усміхнений смайлик}`}</p>
                      <p class="block_16">Incorrect: :-)</p>
                      <p class="block_16">Incorrect: усміхнений смайлик</p>
                    </td>
                    <td class="td_5">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> усміхнений смайлик </i>"
                      </p>
                    </td>
                  </tr>
                </tbody>
                ...
                <tbody class="calibre5">
                  <tr class="tr_5">
                    <td class="td_">
                      ...
                      <p class="block_16">
                        Incorrect: Я мешкаю на вулиці Старокиївській 8 дріб 12.
                      </p>
                      <p class="block_16">
                        Incorrect: Я мешкаю на вулиці Старокиївській вісім дріб
                        дванадцять.
                      </p>
                    </td>
                    <td class="td_1">
                  ...
                  <tr class="tr_2">
                    <td class="td_2">
                      <p class="block_15">Correct: www.fake-domain.com</p>
                      <p class="block_16">
                  ...
                  <tr class="tr_2">
                    <td class="td_4">
                      <p class="block_15">Correct: Він знає 3-4 мови.</p>
                      <p class="block_16">
                    ...
                    <td class="td_5">
                      <p class="block_26">
                        Example audio: "
                        <i class="calibre6"> він знає три чотири мови </i>"
                      </p>
                    </td>
                  </tr>
                </tbody>
              ...
              <table class="table_">
                <tbody class="calibre5">
                  <tr class="tr_">
                    <td class="td_">
                      <p class="block_15">Correct: {`{тире}`}</p>
                      <p class="block_16">Incorrect: -</p>
                    </td>
                    <td class="td_1">
                      <p class="block_17"></p>
                  ...
                  <tr class="tr_">
                    <td class="td_4">
                      <p class="block_15">Correct: {`{знак оклику}`}</p>
                      <p class="block_16">Incorrect: !</p>
                    </td>
                    <td class="td_5">
                      <p class="block_17"></p>
