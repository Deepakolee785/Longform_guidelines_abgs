          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_2}>
                <span className={styles.text_}>Difficult utterances</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_14}>Agreed spelling</p>
              ...
              <p className={styles.block_19}>
                ...
                <span className={styles.text_8}> </span>
                <span className={styles.text_7}>of these words might be:</span>
                <span className={styles.text_8}> </span>
              </p>
              <p className={styles.block_12}>
                <span className={styles.text_9}>○ </span>
              ...
              <p className={styles.block_32}>
                ...
                <span className={styles.text_8}> </span>
                <span className={styles.text_7}>the Unintelligible label.</span>
                <span className={styles.text_8}> </span>
              </p>
              <p className={styles.block_12}>
                <span className={styles.text_9}>○ </span>
              ...
              <p className={styles.block_48}>
                <span className={styles.text_}>Format</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_59}>
                ...
                <span className={styles.text_14}>○ </span>
                <span className={styles.text_15}>Example Audio: </span>
                <span className={styles.text_8}>season three episode two </span>
              </p>
              <p className={styles.block_12}>
                <span className={styles.text_9}>○ </span>
                <span className={styles.text_10}>Correct: </span>
              ...
              <p className={styles.block_65}>
                ...
                <span className={styles.text_8}> </span>
                <span className={styles.text_7}>time, format it as such.</span>
                <span className={styles.text_8}> </span>
              </p>
              <p className={styles.block_12}>
                <span className={styles.text_9}>○ </span>
                <span className={styles.text_10}>Example Audio: </span>
                <span className={styles.text_11}>milk is two ninety nine </span>
              </p>
              <p className={styles.block_13}>
                <span className={styles.text_9}>○ </span>
                <span className={styles.text_10}>Correct: </span>
