        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_199}>Punctuation</p>
              ...
              <p className={styles.block_201}>
                <span className={styles.text_}>Fragments versus sentences</span>
              ...
              <p className={styles.block_212}>
                <span className={styles.calibre2}>
                  Incorrect: Qu'est-ce que je vais acheter ? du pain et du lait
                </span>
              </p>
              ...
              <p className={styles.block_238}>
                <span className={styles.calibre2}>
                  Correct: Je vais au café. Je vais me prendre un C'est combien
                  le cappucino ?
                </span>
              </p>
              ...
              <p className={styles.block_240}>
                <span className={styles.calibre2}>
                  Explanation: Do not put a period, dashes, or ellipses, even if
              ...
              <p className={styles.block_244}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  can complete. The action requested is generally expressed by a
                  trigger (most often a{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_139}>Correct: Affiche mes e-mails.</p>
              ...
              <p className={styles.block_249}>
                <span className={styles.text_}>Commas</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_258}>
                <span className={styles.calibre2}>
                  Correct: Maintenant que tu en parles, on devrait en racheter.
                </span>
              </p>
              <p className={styles.block_259}>
                <span className={styles.calibre2}>
                  Incorrect: Maintenant que tu en parles on devrait en racheter.
                </span>
              </p>
              ...
              <p className={styles.block_261}>
                <span className={styles.calibre2}>
                  Incorrect: Malheureusement les deux fêtes ont eu lieu le même
                  jour.
                </span>
              </p>
              ...
              <p className={styles.block_269}>
                <span className={styles.calibre2}>
                  Incorrect: D'un autre côté les perroquets font des animaux de
                  compagnie assez classes.
                </span>
              </p>
              ...
              <p className={styles.block_283}>
                Explanation: no pause after "bien sûr" Explanation: substantial
                pause after "bien sûr"
              </p>
              ...
              <p className={styles.block_287}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  modifiers. The basic test for this is whether the modifier can
                  be dropped from the{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_288}>
                <span className={styles.calibre2}>
                  Correct: Le président des États-Unis, Barack Obama, était à ce
                  sommet.
                </span>
              </p>
              <p className={styles.block_289}>
                <span className={styles.calibre2}>
                  Incorrect: Le président des États-Unis Barack Obama était à ce
                  sommet.
                </span>
              </p>
              ...
              <p className={styles.block_293}>
                <span className={styles.calibre2}>
                  ...
                  the scope of whom "le président des États-Unis" might refer to
                  because there is only one US president.
                </span>
              </p>
              ...
              <p className={styles.block_295}>
                <span className={styles.calibre2}>
                  Explanation: We do not know whether the speaker has one sister
                  or several. In these cases, assume the appositive is
                  restrictive.
                </span>
              </p>
              ...
              <p className={styles.block_148}>Incorrect: Cordialement Yoann</p>
              <p className={styles.block_90}>Incorrect: Cordialement, Yoann.</p>
              <p className={styles.block_297}>
                <span className={styles.text_2}>
                  Do not use commas in sentences that consist only of a greeting
                  and an addressee. If a{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_139}>Correct: Bonjour, c'est Laure.</p>
              <p className={styles.block_148}>
              ...
              <p className={styles.block_145}>Correct: Marie, rappelle-moi.</p>
              <p className={styles.block_139}>
              ...
              <p className={styles.block_305}>
                <span className={styles.text_}>Intonation marks</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_321}>
                <span className={styles.text_}>Colon and quotation</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_325}>
                ...
                <span className={styles.text_22}>
                  Incorrect: Mon ami a dit "alligator crocodile." Incorrect: Mon
                  ami a dit, "alligator crocodile". Incorrect: Mon ami a dit :
                  "alligator crocodile".
                </span>
              </p>
              ...
              <p className={styles.block_90}>Incorrect: Chercher : Béquille.</p>
              <p className={styles.block_91}>
                <span className={styles.calibre2}>
              ...
              <p className={styles.block_353}>
                <span className={styles.calibre2}>
                  Explanation: If the speaker had said olny "bonjour", it should
                  have been transcribed "Bonjour."
                </span>
              </p>
              <p className={styles.block_354}>
                <span className={styles.calibre2}>
                  Explanation: If the speaker had said only "laisse", it should
                  have been transcribed "Laisse."
                </span>
              </p>
              ...
              <p className={styles.block_145}>Correct: Définir ambidextrie.</p>
              <p className={styles.block_90}>
              ...
              <p className={styles.block_357}>
                <span className={styles.text_}>Other symbols</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_362}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: The apostrophe is in the original media title,
                    so keep it.
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_374}>
                <span className={styles.text_20}>Example audio: " </span>
                <span className={styles.text_23}>ok trois petits points </span>
                <span className={styles.text_20}>" </span>
              </p>
