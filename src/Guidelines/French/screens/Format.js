        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="context text">
              {' '}
              <p className={styles.text_27}>Format </p>
              ...
              <p className={styles.block_424}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  transcribe as a decimal if more than one. If not natural, then
                  write down the full word.
                </span>
                <span className={styles.text_3}> </span>
              </p>
              ...
              <p className={styles.block_264}>Incorrect: 3 et 1/2 + 4 et 1/2</p>
              ...
              <p className={styles.block_437}>
                <span className={styles.calibre2}>
                  Explanation: For items (not units), use the written out form.
                </span>
              </p>
              ...
              <p className={styles.block_456}>
                ...
                <span className={styles.text_35}>racine carrée de trois </span>
              ...
              <p className={styles.block_465}>
                <span className={styles.text_20}>Example audio: " </span>
                <span className={styles.text_23}>treize divisé par sept </span>
                <span className={styles.text_20}>" Example audio: " </span>
              ...
              <p className={styles.block_467}>
                <span className={styles.text_20}>Example audio: " </span>
                <span className={styles.text_23}>deux multiplié par neuf </span>
                <span className={styles.text_20}>"</span>
              </p>
              ...
              <p className={styles.block_469}>
                ...
                <span className={styles.text_24}>" Example audio: " </span>
                <span className={styles.text_25}>deux puissance de neuf </span>
                <span className={styles.text_24}>" </span>
              </p>
              ...
              <p className={styles.block_474}>Incorrect: racine carrée de 9</p>
              ...
              <p className={styles.block_476}>
                <span className={styles.text_2}>
                  Ordinal numbers higher than 9 must always be written in their
                  numerical forms. Simply{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_478}>
                <span className={styles.text_2}>
                  Ordinal numbers from 0 to 9 are spelled out unless they refer
                  to maths, centuries,{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_494}>
                ...
                <span className={styles.text_24}>Example audio: " </span>
                <span className={styles.text_25}>cent à cinq cents euros </span>
                <span className={styles.text_24}>" </span>
              ...
              <p className={styles.block_512}>
                <span className={styles.text_36}>● </span>
                <span className={styles.text_37}>un pouce carré - 1 po² </span>
              </p>
              <p className={styles.block_509}>
                <span className={styles.text_19}>Common scientific terms</span>
                <span className={styles.text_20}> </span>
              </p>
              <p className={styles.block_481}>
                <span className={styles.text_36}>● </span>
              ...
              <p className={styles.block_482}>
                <span className={styles.text_36}>● </span>
                <span className={styles.text_37}>un unité cubique - 1 ³ </span>
              </p>
              <p className={styles.block_482}>
                <span className={styles.text_36}>● </span>
              ...
              <p className={styles.block_440}>
                <span className={styles.calibre2}>
                  Explanation: If the speaker explicitely says "zéro zéro", then
                  transcribe it.
                </span>
              </p>
              ...
              <p className={styles.block_554}>
                <span className={styles.text_}>Address</span>
                <span className={styles.text_1}> </span>
              </p>
              <p className={styles.block_404}>
                <span className={styles.text_20}>Example audio: " </span>
              ...
              <p className={styles.block_139}>Correct: Marie Richard, Rennes</p>
              ...
              <p className={styles.block_247}>
                <span className={styles.text_21}>Correct: http://123.com </span>
                <span className={styles.text_24}>Example audio: " </span>
                <span className={styles.text_25}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_566}>
                <span className={styles.calibre2}>
                  Correct: J'ai tellement #faim que je pourrais manger une pizza
                  entière.
                </span>
              </p>
              ...
              <p className={styles.block_208}>
                <span className={styles.text_21}>Correct: www.amazon.com </span>
                <span className={styles.text_24}>Example audio: " </span>
                <span className={styles.text_25}>
              ...
              <p className={styles.block_574}>
                <span className={styles.text_21}>Correct: www.forbes.com </span>
                <span className={styles.text_24}>Example audio: " </span>
                <span className={styles.text_25}>w w w forbes point com </span>
                <span className={styles.text_24}>" </span>
                <span className={styles.text_21}>
                  Correct: www.facebook.com{' '}
                </span>
                <span className={styles.text_24}>Example audio: " </span>
                <span className={styles.text_25}>w w facebook point com </span>
                <span className={styles.text_24}>" </span>
              </p>
              ...
              <p className={styles.block_579}>
                <span className={styles.text_21}>Correct: PSG versus OM </span>
