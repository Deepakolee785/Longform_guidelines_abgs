        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              {' '}
              <p className={styles.block_140}>Transcription quality</p>
              ...
              <p className={styles.block_142}>
                <span className={styles.text_}>Typo</span>
              ...
              <p className={styles.block_90}>Incorrect: Elle est allemande.</p>
              ...
              <p className={styles.block_148}>Incorrect: Directions Maison.</p>
              <p className={styles.block_149}>
                <span className={styles.text_}>Context error</span>
                <span className={styles.text_1}> </span>
              </p>
              <p className={styles.block_150}>
                <span className={styles.text_2}>
                  A context error occurs when a real word is used incorrectly or
                  when the incorrect form{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_151}>Correct: Les oiseaux chantent.</p>
              <p className={styles.block_90}>Incorrect: Les oiseaux chante.</p>
              ...
              <p className={styles.block_91}>Correct: J'ai quatre tablettes.</p>
              <p className={styles.block_90}>
              ...
              <p className={styles.block_148}>Incorrect: C'est qui Martine ?</p>
              ...
              <p className={styles.block_159}>
                <span className={styles.text_}>Added or missing words</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_171}>
                ...
                <span className={styles.text_23}>
                  <span className={styles.calibre2}>
                    trois cinquante c'est un peu cher pour une barre chocolatée
                  </span>
                </span>
                <span className={styles.text_20}>" </span>
              </p>
              ...
              <p className={styles.block_176}>
                <span className={styles.calibre2}>
                  Correct: Les chaussettes de l'archiduchesse sont-elles sèches
                  sèches ?
                </span>
              </p>
              ...
              <p className={styles.block_179}>
                ...
                <span className={styles.text_23}>
                  <span className={styles.calibre2}>
                    les chaussettes de l'archiduchesse sont-elles sèches sèches
                  </span>
                </span>
                <span className={styles.text_20}>"</span>
              </p>
              ...
              <p className={styles.block_181}>
                <span className={styles.text_}>Substitution</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_184}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  was meant by the speaker. If what the speaker said falls into
                  another category (Context{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_188}>
                <span className={styles.text_}>Spacing</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_197}>
                <span className={styles.text_2}>
                  For all types of punctuation consisting in a double sign, such
              ...
              <p className={styles.block_198}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  French ones « » and do not put a space after the opening quote
