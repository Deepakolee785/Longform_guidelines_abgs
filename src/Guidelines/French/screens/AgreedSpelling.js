        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_594}>Agreed spelling</p>
              ...
              <p className={styles.block_611}>
                ...
                <span className={styles.text_40}>Proper names</span>
              </p>
              ...
              <p className={styles.block_615}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: The celebrity spells her name differently than
                    the more common "Jennifer".
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_629}>
                Correct: C'est quand l'Aïd el-Fitr cette année ? Correct: Joyeux
                Hanouka !
              </p>
              <p className={styles.block_630}>
                <span className={styles.calibre2}>
                  Explanation: In this example, the holiday is "Noël"
                  (Christmas) and "réveillon" (eve) is a common noun and doesn't
              ...
              <p className={styles.block_650}>
                <span className={styles.text_38}>● </span>
                <span className={styles.text_39}>Louis-Ferdinand Céline </span>
                <span className={styles.text_38}>● </span>
              ...
              <p className={styles.block_657}>
                <span className={styles.text_2}>
                  Follow official spelling as found on Géoportail, city council
              ...
              <p className={styles.block_669}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: This is an Ok Google voice command, so spell it
                    with a lowercase k.
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_671}>
                <span className={styles.text_2}>
                  ...
                  spelling yielding more{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>results on Google search.</span>
                <span className={styles.text_3}> </span>
              </p>
              ...
              <p className={styles.block_698}>
                ...
                <span className={styles.text_38}>● </span>
                <span className={styles.text_39}>Samsung Galaxy Note II </span>
                <span className={styles.text_38}>● </span>
                ...
                <span className={styles.text_38}>● </span>
                <span className={styles.text_39}>Samsung Galaxy S4 Free </span>
                <span className={styles.text_38}>● </span>
