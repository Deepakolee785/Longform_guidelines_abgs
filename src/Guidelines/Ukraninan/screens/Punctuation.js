        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_285}>Punctuation</p>
              ...
              <p className={styles.block_287}>Fragments versus sentences</p>
              ...
              <p className={styles.block_332}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: їхали додому та після </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_341}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Рома Сандрека Набрати. </span>
              </p>
              ...
              <p className={styles.block_346}>Commas</p>
              ...
              <p className={styles.block_348}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Де найближча заправка? </span>
              </p>
              ...
              <p className={styles.block_433}>
                ...
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>
                  : Ми мусимо більше працювати, оскільки наша команда невелика.
                </span>
              </p>
              ...
              <p className={styles.block_445}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: сяють, як зорі у небі </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_454}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : List of adjectives defining different qualities, do not use
                  commas in between.
                </span>
              </p>
              ...
              <p className={styles.block_458}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : Restrictive modifier. The appositive "Київ" restricts which
                  city the speaker is referring to.
                </span>
              </p>
              ...
              <p className={styles.block_461}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : Non-restrictive modifier. The appositive "Київ" merely adds
                  information about the city. If the appositive was removed, the
                  meaning of the sentence would remain the same.
                </span>
              </p>
              ...
              <p className={styles.block_464}>
                <span className={styles.text_3}>E</span>
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>: Restrictive modifier. </span>
              </p>
              ...
              <p className={styles.block_467}>
                ...
                <span className={styles.text_3}>
                  ...
                  merely adds more information. If it was removed, the sentence
                  would have slightly less information, but would retain the
                  core of its meaning.
                </span>
              </p>
              ...
              <p className={styles.block_496}>Intonation marks</p>
              ...
              <p className={styles.block_501}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: землетрус на Львівщині </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_506}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Приємно познайомитись. </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_508}>Colon and quotation</p>
              ...
              <p className={styles.block_518}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : No period inside the quotation marks. Put a period after the
                  quotation.
                </span>
              </p>
              ...
              <p className={styles.block_518}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : No period inside the quotation marks. Put a comma and a dash
                  after the quotation.
                </span>
              </p>
              ...
              <p className={styles.block_543}>
                ...
                <span className={styles.text_4}>
                  надіслати повідомлення на нуль шість три дев'ять три три п'ять
                  п'ять шість сім привіт{' '}
                </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_562}>Other symbols</p>
              ...
              <p className={styles.block_577}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Кам'янець-Подільський </span>
              </p>
              ...
              <p className={styles.block_588}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Очі - то зеркало душі. </span>
              </p>
              ...
              <p className={styles.block_594}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Кохаєш її - одружуйся. </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_598}>Spoken punctuation</p>
              ...
              <p className={styles.block_624}>
                ...
                <span className={styles.text_}>XAMPLE AUDIO</span>
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_4}>він знає три чотири мови </span>
                <span className={styles.text_3}>" </span>
              </p>
