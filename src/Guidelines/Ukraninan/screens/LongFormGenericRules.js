        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_132}>Longform generic rules</p>
              ...
              <p className={styles.block_138}>Segmentation</p>
              ...
              <p className={styles.block_143}>Speaker labeling</p>
              ...
              <p className={styles.block_154}>Pii</p>
