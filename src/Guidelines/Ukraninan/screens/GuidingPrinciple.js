        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_47}>Punctuation</p>
              ...
              <p className={styles.block_75}>Format</p>
              ...
              <p className={styles.block_94}>
                <span className={styles.text_}>• </span>
                <span className={styles.text_2}>Example Audio: </span>
                <span className={styles.text_1}>season three episode two </span>
              </p>
              ...
              <p className={styles.block_20}>
                <span className={styles.text_}>• </span>
                <span className={styles.text_2}>Example Audio: </span>
                <span className={styles.text_1}>milk is two ninety nine </span>
              </p>
              ...
              <p className={styles.block_89}>
                <span className={styles.text_}>• </span>
                <span className={styles.text_2}>Correct: </span>
                <span className={styles.text_1}>a few minutes after 3:00 </span>
              </p>
