        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_194}>Transcription quality</p>
              <p className={styles.block_195}>
                Comply with the standard rules of the writing system.
              </p>
              <p className={styles.block_196}>Typo</p>
              ...
              <p className={styles.block_199}>
                ...
                <span className={styles.text_3}>: Додай мене в Фейсбуці. </span>
              </p>
              <p className={styles.block_200}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_}>NCORRECT</span>
                <span className={styles.text_3}>: Додй мене в Фейсбуці. </span>
              </p>
              ...
              <p className={styles.block_205}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Краса по-американськи </span>
              </p>
              ...
              <p className={styles.block_209}>Context error</p>
              ...
              <p className={styles.block_223}>
                ...
                <span className={styles.text_3}>
                  : The word "роман" here is understood as a novel, but not as a
                  name "Роман".
                </span>
              </p>
              ...
              <p className={styles.block_227}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The adjective "нова" (new) is not in agreement with the noun
                  "Україна".
                </span>
              </p>
              ...
              <p className={styles.block_230}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The noun "пам'ятник" (monument) requires the dative case on
                  the following word.
                </span>
              </p>
              <p className={styles.block_231}>Added or missing words</p>
              ...
              <p className={styles.block_240}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : If the speaker says an abbreviated form, transcribe with an
                  abbreviated form and nothing else.
                </span>
              </p>
              ...
              <p className={styles.block_246}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_}>NCORRECT</span>
                <span className={styles.text_3}>: дивитися фільми онлайн </span>
              </p>
              ...
              <p className={styles.block_262}>Substitution</p>
              ...
              <p className={styles.block_267}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: ресторан у місті Київ </span>
              </p>
