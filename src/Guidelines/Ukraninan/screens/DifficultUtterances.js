        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_1260}>Difficult utterances</p>
              <p className={styles.block_1261}>
                Everything relating to problematic utterances (background noise,
                false starts, etc.) or different language varieties.
              </p>
              <p className={styles.block_1262}>Skipping a prompt</p>
              ...
              <p className={styles.block_1265}>Hesitations and truncations</p>
              ...
              <p className={styles.block_1270}>
                ...
                <span className={styles.text_3}>
                  ...
                  "обробляти сад" can be a command, it is ambiguous and is most
                  likely a fragment in this context.
                </span>
              </p>
              ...
              <p className={styles.block_1275}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : Unclear whether they would have said "телефон", "телефонний"
              ...
              <p className={styles.block_1277}>
                ...
                <span className={styles.text_3}>
                  ...
                  used, so the word should be completed. However, do not add any
                  end punctuation - this could be the end of the sentence, but
                  it's also possible that the speaker intended to continue the
                  sentence.
                </span>
              </p>
              ...
              <p className={styles.block_1282}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : End of quote was truncated. Include closing quotation mark.
                </span>
              </p>
              ...
              <p className={styles.block_1296}>Foreign language</p>
              ...
              <p className={styles.block_1299}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: завантажити по блютузу </span>
              ...
              <p className={styles.block_1305}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: фільм з Г'ю Джекменом </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
                  : Foreign personal name, so use{' '}
              ...
              <p className={styles.block_1311}>Accents</p>
