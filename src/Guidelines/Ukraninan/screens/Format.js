          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_640}>
                ...
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>: numbers greater than 9 </span>
              </p>
              ...
              <p className={styles.block_644}>
                <span className={styles.text_3}>E</span>
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>: numbers greater than 9 </span>
              </p>
              ...
              <p className={styles.block_654}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The numbers refer to different nouns, so this rule does not
                  apply here.
                </span>
              </p>
              ...
              <p className={styles.block_688}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: дівчинці 5 1/2 місяців </span>
              </p>
              ...
              <p className={styles.block_700}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The noun agrees with the fractional part if it is ed to the
                  integer with the conjunction "and".
                </span>
              </p>
              ...
              <p className={styles.block_720}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>три з половиною гривні </span>
                <span className={styles.text_9}>" </span>
              </p>
              ...
              <p className={styles.block_747}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : Elements "дво-", "три-", "чотири-" are connected to the root
                  that starts with a consonant, while their variations "двох-",
                  "трьох-", "чотирьох-" are used when the second component
                  starts with a vowel.
                </span>
              </p>
              ...
              <p className={styles.block_756}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: 5-а серія 3-го сезону </span>
                <span className={styles.text_9}>E</span>
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>
              ...
              <p className={styles.block_765}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>нуль п'ять тридцять два </span>
              </p>
              ...
              <p className={styles.block_782}>
                ...
                <span className={styles.text_}>XAMPLE AUDIO</span>
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_4}>п'ять помножене на шість </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_791}>Currency and unit</p>
              ...
              <p className={styles.block_802}>
                ...
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_4}>
                  ціна на бензин виросла до чотирьох вісімдесяти дев'яти за літр{' '}
                </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_836}>For degrees, use the ° symbol.</p>
              ...
              <p className={styles.block_838}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>п'ять градусів цельсія </span>
                <span className={styles.text_9}>" </span>
              </p>
              ...
              <p className={styles.block_842}>
                ...
                <span className={styles.text_}>XAMPLE AUDIO</span>
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_4}>сімдесят за фаренгейтом </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_731}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: У Києві сьогодні -10°. </span>
                <span className={styles.text_9}>E</span>
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>
              ...
              <p className={styles.block_847}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>пройдіть сто метрів та </span>
              </p>
              ...
              <p className={styles.block_851}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>він пройшов десять миль </span>
                <span className={styles.text_9}>" </span>
              </p>
              ...
              <p className={styles.block_860}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Нам бракує 50 г цукру. </span>
                <span className={styles.text_9}>E</span>
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>
              ...
              <p className={styles.block_878}>Common technical abbreviations</p>
              ...
              <p className={styles.block_923}>Date and time</p>
              ...
              <p className={styles.block_928}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>дванадцяте липня тисяча </span>
              </p>
              ...
              <p className={styles.block_952}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>об одинадцятій тридцять </span>
                <span className={styles.text_9}>" </span>
              </p>
              ...
              <p className={styles.block_965}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>ми їдемо об одинадцятій </span>
              </p>
              ...
              <p className={styles.block_968}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Зустрінемося опівдні. </span>
              </p>
              <p className={styles.block_969}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_}>NCORRECT</span>
                <span className={styles.text_3}>: Зустрінемося о 12:00. </span>
              </p>
              ...
              <p className={styles.block_974}>Address</p>
              ...
              <p className={styles.block_1007}>Web</p>
              ...
              <p className={styles.block_1034}>Abbreviation</p>
              ...
              <p className={styles.block_1059}>
                ...
                <span className={styles.text_10}>XAMPLE AUDIO</span>
                <span className={styles.text_9}>: " </span>
                <span className={styles.text_11}>ця конференція лише для </span>
              </p>
