            ...
            <div className="content text">
              ...
              <p className={styles.block_1075}>
                ...
                <span className={styles.text_4}>
                  а бе ве ге ґе де е йе же зе и і йі йот ка ел ем ен о пе ер ес
                  те у еф ха це че ша шча м'який знак йу йа{' '}
                </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_1083}>Interjections</p>
              ...
              <p className={styles.block_1085}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: гей, ха, хаха, хахаха </span>
              </p>
              ...
              <p className={styles.block_1111}>
                ...
                <span className={styles.text_20}>
                  <sub className={styles.calibre1}>Proper names </sub>
                </span>
              </p>
              ...
              <p className={styles.block_1134}>Brand and product</p>
              ...
              <p className={styles.block_1145}>
                ...
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>: officially camel case </span>
              </p>
              ...
              <p className={styles.block_503}>
                ...
                Outside of this phrase, use the spelling "окей", and do not
                capitalize this word unless it begins a sentence.
              </p>
              ...
              <p className={styles.block_1160}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: кінотеатр Ультрамарин </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_1182}>
                ...
                <span className={styles.text_20}>
                  <sub className={styles.calibre1}>Media title </sub>
                </span>
              </p>
              ...
              <p className={styles.block_1184}>
                Capitalize only the first word in media titles in Ukrainian. If
                there is a proper noun in the title, capitalize it as well.
                Capitalize foreign media titles in accordance with the
                capitalization conventions of the media title's original
                language. For English media titles, capitalize every word except
                articles, conjunctions, and prepositions unless they are the
                first word.
              </p>
              ...
              <p className={styles.block_760}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: слухати Джамала Верше </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XPLANATION</span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_1212}>Multiple spellings</p>
              <p className={styles.block_1213}>
                ...
                Sciences on http://lcorp.ulif.org.ua/dictua/, and search for the
                word in the multi-dictionary search bar. If there is no entry,
                Google the word and use the form with the most hits.
              </p>
              ...
              <p className={styles.block_1247}>
                searches "ашрафія", finds correct results. Transcribe "Ашрафія".
              </p>
              ...
              <p className={styles.block_550}>
                ...
                two or more times, it should be concatenated and connected with
                a hyphen (e.g. "ха-ха-ха", "няв-няв", "чік-чірік").
              </p>
