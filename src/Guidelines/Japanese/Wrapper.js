...
const Wrapper = ({ children }) => {
  const menuItems = [
    ...
    },
    {
      ...
      path: '',
      subMenus: [
        { label: 'Overview', path: '/japanese/longform_generic_rules' },
        {
          label: 'Unintelligible or foreign or singing',
          path:
            '/japanese/longform_generic_rules#unintelligible-or-foreign-or-singing',
        },
        {
          label: 'Segmentation',
          path: '/japanese/longform_generic_rules#segmentation',
        },
        {
          label: 'Speaker labelling',
          path: '/japanese/longform_generic_rules#speaker-labeling',
        },
        {
          label: 'Audio labels',
          path: '/japanese/longform_generic_rules#audio-labels',
        },
        { label: 'Pii', path: '/japanese/longform_generic_rules#pii' },
      ],
    },
    // {
    ...
    //   path: '',
    //   subMenus: [
    //     { label: 'Overview', path: '/japanese/transcription_quality' },
    ...
    //   path: '',
    //   subMenus: [
    //     { label: 'Overview', path: '/japanese/punctuation' },
    //     {
    ...
    //   path: '',
    //   subMenus: [
    //     { label: 'Overview', path: '/japanese/format' },
    ...
    //   path: '',
    //   subMenus: [
    //     { label: 'Overview', path: '/japanese/agreed_spelling' },
    ...
    //   path: '',
    //   subMenus: [
    //     { label: 'Overview', path: '/japanese/difficult_utterances' },
    ...
    //     {
    //       label: 'Accents ',
    //       path: '/japanese/difficult_utterances#accents',
    //     },
    //   ],
    // },
  ]
  return (
    <MasterPage menuItems={menuItems} appTitle="Japnese">
      {children}
    </MasterPage>
  )
}
