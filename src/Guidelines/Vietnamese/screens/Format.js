            ...
            <div className="content text">
              ...
              <p className={styles.block_231}>
                ...
                <span className={styles.text_2}>
                  : Họ mua 9 hoặc 10 con cá vàng ở cửa hàng thú nuôi trong nhà.
                </span>
              </p>
              ...
              <p className={styles.block_236}>
                • For long numbers (4+ digits), use a dot as thousand separator.
              </p>
              ...
              <p className={styles.block_247}>
                ...
                <span className={styles.text_2}>XAMPLE AUDIO</span>
                <span className={styles.text_2}>: " </span>
                <span className={styles.text_8}>đưa cho tôi nửa cái bánh </span>
                <span className={styles.text_2}>" </span>
              </p>
              ...
              <p className={styles.block_280}>Currency and unit</p>
              ...
              <p className={styles.block_284}>
                ...
                <span className={styles.text_6}>XAMPLE AUDIO</span>
                <span className={styles.text_6}>: " </span>
                <span className={styles.text_7}>bảy triệu năm trăm ngàn </span>
              </p>
              ...
              <p className={styles.block_317}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Tôi sống ở đó 6 tháng. </span>
              </p>
              ...
              <p className={styles.block_323}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Đặt báo thức cho 5:45. </span>
              </p>
              <p className={styles.block_324}>
                <span className={styles.text_2}>I</span>
                <span className={styles.text_2}>NCORRECT</span>
                <span className={styles.text_2}>: Đặt báo thức cho 545. </span>
              </p>
              ...
              <p className={styles.block_345}>
                <span className={styles.text_15}>❖ </span>
                <span className={styles.text_16}>Kilômét trên giờ - km/h </span>
              </p>
              <p className={styles.block_346}>• Common measurements of area</p>
              ...
              <p className={styles.block_368}>Date and time</p>
              ...
              <p className={styles.block_383}>Address</p>
              ...
              <p className={styles.block_393}>Web</p>
              ...
              <p className={styles.block_408}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Tôi biết Bác sĩ Tánh. </span>
              </p>
