        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_504}>Difficult utterances</p>
              ...
              <p className={styles.block_506}>Skipping a prompt</p>
              ...
              <p className={styles.block_509}>Hesitations and truncations</p>
              ...
              <p className={styles.block_511}>
                ...
                <span className={styles.text_2}>
                  : Cho tôi xem thời tiết ở Sapa. Cho tôi xem thời tiết ở Sapa.
                </span>
              </p>
              <p className={styles.block_512}>
                ...
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>
                  : Bạn dùng dụng cụ nào để phát quang cái vườn? phát quang cái
                  vườn
                </span>
              </p>
              ...
              <p className={styles.block_544}>Foreign language</p>
              <p className={styles.block_545}>Accents</p>
