        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_96}>Punctuation</p>
              ...
              <p className={styles.block_98}>Fragments versus sentences</p>
              ...
              <p className={styles.block_107}>
                ...
                should be considered complete sentences and punctuated as such.
              </p>
              ...
              <p className={styles.block_111}>
                ...
                a sentence. Add end punctuation to sentence fragments that sound
              ...
              <p className={styles.block_117}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Gửi Gmail cho Nguyễn. </span>
              </p>
              ...
              <p className={styles.block_122}>
                ...
                above rules and examples, do not capitalize or punctuate it as a
                sentence.
              </p>
              <p className={styles.block_123}>Commas</p>
              ...
              <p className={styles.block_129}>
                ...
                <span className={styles.text_2}>XPLANATION</span>
                <span className={styles.text_2}>
                  : "Công viên Yosemite" is a phrase that focuses the meaning of
                  the sentence.
                </span>
              </p>
              ...
              <p className={styles.block_140}>
                ...
                whether the modifier can be dropped from the sentence and still
              ...
              <p className={styles.block_141}>
                ...
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>
                  : Tổng thống Obama, người được bầu năm 2008, đã được tấn phong
                  năm 2009.
                </span>
              </p>
              ...
              <p className={styles.block_150}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Thanh, bạn khoẻ không? </span>
              </p>
              <p className={styles.block_151}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Loan, gọi lại cho tôi. </span>
              </p>
              ...
              <p className={styles.block_156}>Intonation marks</p>
              ...
              <p className={styles.block_158}>
                <span className={styles.text_}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_}>: Vào lúc 3:00 giờ sáng? </span>
                <span className={styles.text_1}>E</span>
                <span className={styles.text_1}>XPLANATION</span>
                <span className={styles.text_1}>
              ...
              <p className={styles.block_160}>
                <span className={styles.text_}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_}>: Anh có nói thật không? </span>
                <span className={styles.text_1}>E</span>
                <span className={styles.text_1}>XPLANATION</span>
                <span className={styles.text_1}>
              ...
              <p className={styles.block_165}>Colon and quotation</p>
              ...
              <p className={styles.block_169}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: Loan nói, "diamonds". </span>
              </p>
              ...
              <p className={styles.block_172}>
                ...
                <span className={styles.text_2}>XPLANATION</span>
                <span className={styles.text_2}>
                  : Text in quotation marks qualifies as a sentence. Do not add
                  excess punctuation.
                </span>
              </p>
              ...
              <p className={styles.block_193}>
                ...
                <span className={styles.text_1}>I</span>
                <span className={styles.text_1}>NCORRECT</span>
                <span className={styles.text_1}>: Định nghĩa "zucchini". </span>
              </p>
              <p className={styles.block_194}>Other symbols</p>
              ...
              <p className={styles.block_117}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_2}>ORRECT</span>
                <span className={styles.text_2}>: chuyến bay Huế-Đà Lạt </span>
              </p>
              ...
              <p className={styles.block_202}>Spoken punctuation</p>
