        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_62}>Transcription quality</p>
              <p className={styles.block_63}>
                Comply with the standard rules of the writing system.
              </p>
              <p className={styles.block_64}>Typo</p>
              ...
              <p className={styles.block_72}>Added or missing words</p>
              ...
              <p className={styles.block_85}>Substitution</p>
              ...
              <p className={styles.block_87}>
                <span className={styles.text_}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_}>: nhân vật của Star Wars </span>
                <span className={styles.text_1}>I</span>
                <span className={styles.text_1}>NCORRECT</span>
                <span className={styles.text_1}>: nhân vật của Star Trek </span>
              </p>
              ...
              <p className={styles.block_89}>Spacing</p>
