          ...
          <Paper className={classes.content}>
            ...
            <div className="content">
              ...
              <div id="speaker-labeling">
                ...
                <p className={styles.block_101}>Correct: speaker 1</p>
                <p className={styles.block_102}>Incorrect: Speaker 1</p>
              ...
              <div id="PII">
                ...
                <p className={styles.block_114}>● CREDIT_CARD_NUMBER</p>
                <p className={styles.block_124}>● EMAIL</p>
                <p className={styles.block_124}>● PHONE_NUMBER</p>
                <p className={styles.block_124}>● SOCIAL_INSURANCE_NUMBER</p>
                <p className={styles.block_114}>● DRIVER_LICENSE_NUMBER</p>
                <p className={styles.block_124}>
                  ● NATIONAL_HEALTH_SERVICE_NUMBER
                </p>
                <p className={styles.block_125}>● SOCIAL_SECURITY_NUMBER</p>
                <p className={styles.block_124}>● PASSPORT</p>
                ...
                <p className={styles.block_138}>● MEDICARE_NUMBER</p>
                <p className={styles.block_124}>
                ...
                <p className={styles.block_124}>● TAXPAYER_REFERENCE</p>
                ...
                <p className={styles.block_150}>number, or address.</p>
                <p className={styles.block_149}>Correct: Pet names</p>
                <p className={styles.block_149}>
