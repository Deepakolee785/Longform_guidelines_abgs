              ...
              <div id="pii">
                ...
                <div className="blue-text">
                  ...
                  <p className={styles.block_174}>
                    MICR line. MICR means Magnetic Image Character Recognition.
                    The MICR line is made up of three sets of numbers. The first
                    set is called the ABA Bank Routing Number or routing transit
                    number (RTN)
                  </p>
                  <p className={styles.block_152}>
