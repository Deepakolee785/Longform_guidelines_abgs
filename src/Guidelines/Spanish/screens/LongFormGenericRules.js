        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content">
              {' '}
              <p className={styles.block_79}>Longform generic rules</p>
              ...
              <p className={styles.block_83}>
                ...
                <span className={styles.text_18}>Segmentation </span>
              </p>
              ...
              <p className={styles.block_87}>Speaker labeling</p>
              ...
              <p className={styles.block_91}>Correct: pre recorded speaker 1</p>
              <p className={styles.block_90}>
                Incorrect: pre-recorded speaker_1
              </p>
              <p className={styles.block_91}>Correct: unidentifiable speaker</p>
              ...
              <p className={styles.block_96}>Audio labels</p>
              ...
              <p className={styles.block_99}>
                <span className={styles.calibre1}>
                  ...
                  multi-frequency.' This is the sound you hear when a number is
                  pressed during a phone call. For example, 'Press one to speak
                  to a representative' DTMF.
                </span>
              </p>
              <p className={styles.block_100}>
                ● Foreign Speech: Use this label if the speaker is not talking
                in the target language. ● Laughter: Use this label when you hear
                laughter.
              </p>
              ...
              <p className={styles.block_107}>Pii</p>
              ...
              <p className={styles.block_112}>● NAME: First and/or Last name</p>
              ...
              <p className={styles.block_118}>
                <span className={styles.calibre1}>
                  ...
                  are all OK to transcribe. ● MRN (medical record number)
                </span>
              </p>
              ...
              <p className={styles.block_120}>
                <span className={styles.calibre1}>
                  ...
                  health care called a Personal Health Number (PHN) ● OHIP:
              ...
              <p className={styles.block_129}>
                <span className={styles.calibre1}>
                  ...
                  the Personal Records Database (BRP). ● ICD_CODE: International
              ...
              <p className={styles.block_130}>● FDA_CODE: Prescription drug</p>
              <p className={styles.block_102}>
