        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_148}>Incorrect: Me voy a barcelona.</p>
              <p className={styles.block_149}>Context error</p>
              ...
              <p className={styles.block_89}>Correct: ¿Dónde queda el Tigre?</p>
              <p className={styles.block_148}>
              ...
              <p className={styles.block_160}>Added or missing words</p>
              ...
              <p className={styles.block_168}>Substitution</p>
              ...
              <p className={styles.block_171}>Spacing</p>
