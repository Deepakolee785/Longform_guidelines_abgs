        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              {' '}
              <p className={styles.block_410}>Agreed spelling</p>
              ...
              <p className={styles.block_412}>
                <span className={styles.text_}>Spelling out</span>
              ...
              <p className={styles.block_416}>
                <span className={styles.calibre2}>
                  Correct: a b c ch d e f g h i k l ll m n ñ o p q r rr s t u v
                  w x y z
                </span>
              </p>
              ...
              <p className={styles.block_419}>
                ...
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>
                    Explanation: Pronounced the word "FIFA", or spelled out "f i
                    f a".
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_151}>Correct: jaja, ay, ayayay, oh</p>
              ...
              <p className={styles.block_139}>Correct: Fito &amp; Fitipaldis</p>
              <p className={styles.block_432}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  in your spelling. If unsure, refer to news articles, official
                  city or celebrity websites, IMDb,{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_148}>Incorrect: Zlatan Ibrahimović</p>
              <p className={styles.block_433}>
                Mispronounced proper names should be corrected.
              </p>
              <p className={styles.block_355}>
                <span className={styles.text_19}>Correct: Alejandro Sanz </span>
                <span className={styles.text_32}>Example audio: " </span>
              ...
              <p className={styles.block_436}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  difference is minimal. "Minimal differences" refers to adding
                  or dropping articles,{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>possessives, and plurals.</span>
                <span className={styles.text_3}> </span>
              </p>
              ...
              <p className={styles.block_437}>
                <span className={styles.text_19}>Correct: Descendientes </span>
                <span className={styles.text_20}>
              ...
              <p className={styles.block_441}>
                ...
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>
                    Explanation: Officially "craigslist" per its privacy policy,
                    but capitalize it.
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_155}>
                ...
                <span className={styles.text_20}>Incorrect: BURGER KING </span>
              </p>
              <p className={styles.block_156}>
                <span className={styles.calibre2}>
              ...
              <p className={styles.block_468}>
                <span className={styles.text_43}>● </span>
                <span className={styles.text_44}>Irados do Club Penguin </span>
                <span className={styles.text_43}>● </span>
              ...
              <p className={styles.block_487}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  conjunctions and prepositions unless they are the first word.
                </span>
              </p>
              ...
              <p className={styles.block_491}>
                <span className={styles.text_19}>Correct: Transformers 2 </span>
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_338}>
                <span className={styles.text_39}>● </span>
                <span className={styles.text_40}>El gato en el sombrero </span>
              </p>
              <p className={styles.block_338}>
                <span className={styles.text_39}>● </span>
              ...
              <p className={styles.block_520}>
                ...
                <span className={styles.text_20}>Incorrect: He llegao.: </span>
              </p>
              <p className={styles.block_512}>
                <span className={styles.text_21}>Example audio: " </span>
              ...
              <p className={styles.block_522}>
                <span className={styles.text_2}>
                  For Catalan, Galician and some infrequent Spanish words, words
                  apostrophe is{' '}
                </span>
                <span className={styles.text_3}> </span>
