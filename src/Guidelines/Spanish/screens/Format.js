          ...
          <Paper className={classes.content}>
            ...
            <div className="context text">
              ...
              <p className={styles.block_294}>
                ...
                <span className={styles.text_19}>Correct: segundo grado </span>
              </p>
              ...
              <p className={styles.block_311}>
                ...
                <span className={styles.text_32}>Example audio: " </span>
                <span className={styles.text_33}>videojuego diablo tres </span>
                <span className={styles.text_32}>"</span>
              </p>
              ...
              <p className={styles.block_315}>
                ...
                <span className={styles.text_20}>Incorrect: 650 25 30 00 </span>
              </p>
              <p className={styles.block_316}>
                <span className={styles.text_21}>Example audio: " </span>
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    seiscientos cincuenta doscientos cincuenta y tres cero cero
                    cero
                  </span>
                </span>
                <span className={styles.text_21}>" </span>
              ...
              <p className={styles.block_325}>
                ...
                <span className={styles.text_36}>raíz cuadrada de veinte </span>
                <span className={styles.text_35}>" </span>
                <span className={styles.text_37}>Currency and unit</span>
              ...
              <p className={styles.block_139}>Correct: Compró 2 kg de papas.</p>
              ...
              <p className={styles.block_343}>
                <span className={styles.text_25}>Common scientific terms</span>
                <span className={styles.text_21}> </span>
              </p>
              <p className={styles.block_337}>
                <span className={styles.text_39}>● </span>
              ...
              <p className={styles.block_357}>minutes, do not append ":00".</p>
              ...
              <p className={styles.block_361}>
                <span className={styles.calibre2}>
                  Explanation: Do not use dot as the time separator. Use colons.
                </span>
              </p>
              ...
              <p className={styles.block_364}>
                <span className={styles.text_19}>Correct: Es medianoche. </span>
                <span className={styles.text_32}>Example audio: " </span>
              ...
              <p className={styles.block_139}>Correct: Pizza Hut, Barcelona</p>
              <p className={styles.block_139}>Correct: 18001 Granada</p>
              <p className={styles.block_377}>
                <span className={styles.text_26}>
                  If an address contains a mistake, do not correct it, stick to
              ...
              <p className={styles.block_387}>
                <span className={styles.text_19}>Correct: www.google.es </span>
                <span className={styles.text_32}>Example audio: " </span>
                <span className={styles.text_33}>
              ...
              <p className={styles.block_388}>
                <span className={styles.text_19}>Correct: http://123.com </span>
                <span className={styles.text_32}>Example audio: " </span>
                <span className={styles.text_33}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_390}>
                <span className={styles.text_19}>Correct: www.amazon.com </span>
                <span className={styles.text_32}>Example audio: " </span>
                <span className={styles.text_33}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_396}>
                ...
                <span className={styles.text_32}>Example audio: " </span>
                <span className={styles.text_33}>w w facebook punto com </span>
                <span className={styles.text_32}>" </span>
              </p>
              ...
              <p className={styles.block_398}>
                <span className={styles.text_19}>Correct: www.elmundo.es </span>
                <span className={styles.text_32}>Example audio: " </span>
                <span className={styles.text_33}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_91}>Correct: Buenas noches, señora.</p>
              <p className={styles.block_139}>
