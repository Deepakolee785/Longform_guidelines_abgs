        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_179}>Punctuation</p>
              ...
              <p className={styles.block_223}>
                <span className={styles.calibre2}>
                  ...
                  the scope of whom "el presidente de los Estados Unidos" might
                  refer to because there is only one US president.
                </span>
              </p>
              <p className={styles.block_224}>
                <span className={styles.calibre2}>
                  Explanation: Restrictive. "Juan" narrows the scope of whom "mi
                  colega" might refer to because people tend to have multiple
                  coworkers.
                </span>
              </p>
              ...
              <p className={styles.block_151}>Correct: María, ¿vas a venir?</p>
              <p className={styles.block_139}>
              ...
              <p className={styles.block_232}>
                <span className={styles.text_19}>Correct: No, no lo sé. </span>
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>
                    Explanation: Person makes an obvious pause between the first
                    and second "no".
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_238}>
                ...
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>
                    Explanation: Regardless of the intonation, it is built as a
                    question, and therefore punctuated as
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_244}>
                ...
                <span className={styles.text_30}>Colon and quotation</span>
              ...
              <p className={styles.block_151}>Correct: Y me dijo, "pelota".</p>
              <p className={styles.block_90}>Incorrect: Y me dijo: "pelota".</p>
              <p className={styles.block_148}>Incorrect: Y me dijo "pelota."</p>
              ...
              <p className={styles.block_261}>
                <span className={styles.text_26}>
                  Do not use quotation marks for media titles, lyrics or brands
                  in web searches.
                </span>
                <span className={styles.text_27}> </span>
                <span className={styles.text_28}>
              ...
              <p className={styles.block_273}>
                ...
                <span className={styles.text_33}>porfa punto punto punto </span>
              ...
              <p className={styles.block_276}>
                <span className={styles.calibre2}>
                  Correct: Estaremos todos {`{dos punto}`} Pedro su hermana Lola
                  y Lucas
                  {` {punto}`}
                </span>
              </p>
              ...
              <p className={styles.block_280}>
                <span className={styles.text_2}>
                  For "signo de interrogación" and "signo de exclamación" do not
                  add the inverted{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
