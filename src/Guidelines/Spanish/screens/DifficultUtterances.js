        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.text_47}>Difficult utterances </p>
              ...
              <p className={styles.block_412}>
                <span className={styles.text_}>Skipping a prompt</span>
              ...
              <p className={styles.block_540}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  sentence if it's restating (as a sentence) what the person has
                  said.
                </span>
                <span className={styles.text_3}> </span>
              </p>
              <p className={styles.block_151}>Correct: Te quiero. Te quiero.</p>
              ...
              <p className={styles.block_139}>Correct: Do you like it? Mhm.</p>
              ...
              <p className={styles.block_552}>
                <span className={styles.text_}>Foreign language</span>
                <span className={styles.text_1}> </span>
              </p>
              <p className={styles.block_553}>
                <span className={styles.text_}>Accents</span>
                <span className={styles.text_1}> </span>
              </p>
              <p className={styles.block_554}>
                <span className={styles.text_2}>
                  Latin American and Iberian spellings may vary according to the
                  locale. Choose the{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
