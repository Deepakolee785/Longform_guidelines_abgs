        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="context text">
              {' '}
              <p className={styles.block_287}>Format</p>
              ...
              <p className={styles.block_177}>
                <span className={styles.text_}>Number</span>
              ...
              <p className={styles.block_139}>Correct: Mam dwa psy i trzy koty.</p>
              <p className={styles.block_150}>Incorrect: Mam 2 psy i 3 koty.</p>
              <p className={styles.block_139}>
                <span className={styles.calibre2}>
                  Correct: Muszę zamówić 168 plastikowych{' '}
                </span>
              </p>
              <p className={styles.block_291}>talerzy na jutrzejszą imprezę.</p>
              <p className={styles.block_150}>
                <span className={styles.calibre2}>
              ...
              <p className={styles.block_295}>Incorrect: trzy przecinek czternaście</p>
              <p className={styles.block_296}>Explanation: decimal number</p>
              <p className={styles.block_297}>Correct: Mieszkam na ulicy Wyzwolenia 11.</p>
              ...
              <p className={styles.block_300}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>transcribe both as numerals.</span>
                <span className={styles.text_3}> </span>
              </p>
              <p className={styles.block_89}>Correct: Kupili 9 lub 10 złotych rybek.</p>
              ...
              <p className={styles.block_302}>
                <span className={styles.text_21}>Correct: 1 milion złotych </span>
                ...
                <span className={styles.text_21}>Correct: milion kobiet </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_305}>
                <span className={styles.text_21}>Correct: 0 1 2 3 4 5 6 </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_308}>
                <span className={styles.text_21}>Correct: 7 9 8 0 4 1 1 13 </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_309}>Explanation: list of numbers, no comma</p>
              ...
              <p className={styles.block_314}>
                <span className={styles.text_21}>Correct: 1/4 szklanki cukru </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>jedna czwarta szklanki cukru </span>
                <span className={styles.text_31}>" </span>
              </p>
              <p className={styles.block_315}>
                ...
                <span className={styles.text_26}>Correct: 3 i 1/2 kilometra </span>
                <span className={styles.text_27}>Explanation: trzy i pół kilometra </span>
              </p>
              <p className={styles.block_316}>
                <span className={styles.text_21}>Correct: 5 i 1/2 miesiąca </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_317}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  mixed numbers, write the whole number part out in words if it
                  is under ten, otherwise{' '}
                </span>
                <span className={styles.text_3}> </span>
              ...
              <p className={styles.block_320}>
                <span className={styles.text_19}>Example audio: " </span>
                <span className={styles.text_20}>pół ciasta jest dla tomka </span>
                <span className={styles.text_19}>" </span>
              </p>
              ...
              <p className={styles.block_323}>
                <span className={styles.text_21}>Correct: To kosztuje 10,50 zł. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_324}>Explanation: Use a comma for decimals.</p>
              <p className={styles.block_325}>
                <span className={styles.text_21}>Correct: To kosztuje 10,50. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_328}>
                ...
                <span className={styles.text_25}> </span>
                <span className={styles.text_26}>Correct: ośmiometrowa fala </span>
              ...
              <p className={styles.block_329}>
                <span className={styles.text_21}>Correct: czterodrzwiowa toyota </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_332}>
                <span className={styles.text_21}>Correct: król Henryk VIII </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_336}>
                ...
                <span className={styles.text_25}> </span>
                <span className={styles.text_26}>Correct: sezon 3 odcinek 2 </span>
                <span className={styles.text_33}>Example audio: " </span>
                <span className={styles.text_34}>sezon trzeci odcinek drugi </span>
                <span className={styles.text_33}>" </span>
              </p>
              ...
              <p className={styles.block_338}>
                ...
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>kaliber dwadzieścia dwa </span>
                <span className={styles.text_31}>" </span>
              </p>
              ...
              <p className={styles.block_343}>
                ...
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
                    siedemdziesiąt cztery osiem cztery trzy dwa osiem dwa sześć
                  </span>
                </span>
                <span className={styles.text_31}>" </span>
              </p>
              <p className={styles.block_344}>Explanation: landline with area code</p>
              <p className={styles.block_345}>
                ...
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
                    sześć dziewięć zero jeden osiem zero siedem numer wewnętrzny
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_347}>
                <span className={styles.text_21}>Correct: +48 54 123 12 12 </span>
                <span className={styles.text_22}>
                  Explanation: landline with country code{' '}
                </span>
                <span className={styles.text_21}>Correct: 571 231 212 </span>
                <span className={styles.text_22}>Explanation: mobile phone number </span>
                <span className={styles.text_21}>Correct: 800 12 12 12 </span>
                <span className={styles.text_22}>Explanation: toll-free number </span>
                <span className={styles.text_21}>Correct: 70 123 12 12 </span>
                <span className={styles.text_22}>Explanation: premium-rate services</span>
              </p>
              <p className={styles.block_338}>
                <span className={styles.text_21}>Correct: 801 12 12 12 </span>
                <span className={styles.text_22}>Explanation: shared-cost services </span>
              </p>
              ...
              <p className={styles.block_350}>
                ...
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>szesnaście podzielić na cztery </span>
                </span>
                <span className={styles.text_31}>" </span>
              </p>
              ...
              <p className={styles.block_352}>
                ...
                <span className={styles.text_33}>" </span>
                <span className={styles.text_28}>Currency and unit</span>
              ...
              <p className={styles.block_354}>
                <span className={styles.text_21}>Correct: 10 zł to ile dolarów? </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>dziesięć złotych to ile dolarów </span>
                </span>
                <span className={styles.text_31}>"</span>
              </p>
              <p className={styles.block_355}>
                <span className={styles.text_2}>
                  ...
                  of currency, transcribe{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>with the currency symbol.</span>
                <span className={styles.text_3}> </span>
              </p>
              <p className={styles.block_356}>
                <span className={styles.text_21}>Correct: Mleko kosztuje 5,40 zł. </span>
                <span className={styles.text_22}>Incorrect: Mleko kosztuje 5,40. </span>
              </p>
              ...
              <p className={styles.block_358}>
                <span className={styles.text_24}>
                  For grosz-only quantities, the word "grosz" should follow the
                  amount.
                </span>
                <span className={styles.text_25}> </span>
              ...
              <p className={styles.block_360}>
                <span className={styles.text_21}>Correct: Wydałem na to 4 tysiaki. </span>
                <span className={styles.text_22}>Incorrect: Wydałem na to 4 000 zł. </span>
              </p>
              <p className={styles.block_361}>
                <span className={styles.text_21}>Correct: Wydałem na to 4 koła. </span>
                <span className={styles.text_22}>Incorrect: Wydałem na to 4 000 zł. </span>
              </p>
              <p className={styles.block_361}>
                <span className={styles.text_21}>Correct: Wydałem na to 4 stówy. </span>
                <span className={styles.text_22}>Incorrect: Wydałem na to 400 zł. </span>
              </p>
              <p className={styles.block_362}>
                <span className={styles.text_19}>Example audio: " </span>
                <span className={styles.text_20}>wydałem na to cztery tysiaki </span>
                <span className={styles.text_19}>" Example audio: " </span>
                <span className={styles.text_20}>wydałem na to cztery koła </span>
                <span className={styles.text_19}>" Example audio: " </span>
                <span className={styles.text_20}>wydałem na to cztery stówy </span>
                <span className={styles.text_19}>" </span>
              </p>
              <p className={styles.block_363}>
                ...
                <span className={styles.text_33}>Example audio: " </span>
                <span className={styles.text_34}>muszę pożyczyć kilka złotych </span>
                <span className={styles.text_33}>"</span>
              </p>
              <p className={styles.block_364}>
                ...
                <span className={styles.text_25}> </span>
                <span className={styles.text_26}>Correct: banknot dwudziestozłotowy </span>
              </p>
              <p className={styles.block_359}>
                <span className={styles.text_23}>
              ...
              <p className={styles.block_369}>
                <span className={styles.text_21}>Correct: W Warszawie jest -10°. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_197}>
                <span className={styles.text_21}>Correct: W Warszawie jest -5. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>w warszawie jest minus pięć </span>
                <span className={styles.text_31}>" </span>
              </p>
              ...
              <p className={styles.block_332}>
                <span className={styles.text_21}>Correct: Muszę kupić 2 l mleka. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>muszę kupić dwa litry mleka </span>
                <span className={styles.text_31}>" </span>
              </p>
              <p className={styles.block_373}>
                ...
                <span className={styles.text_25}> </span>
                <span className={styles.text_26}>Correct: Mój kot waży 5 kg. </span>
              </p>
              <p className={styles.block_374}>Correct: Muszę kupić 2 kg mąki.</p>
              ...
              <p className={styles.block_377}>
                ...
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>
                    znajdź tapetę o rozdzielczości tysiąc dwadzieścia cztery na
                    siedemset sześćdziesiąt osiem
                  </span>
                </span>
                <span className={styles.text_19}>" </span>
              </p>
              ...
              <p className={styles.block_379}>
                <span className={styles.text_21}>Correct: Nastaw budzik na 5:45. </span>
                <span className={styles.text_22}>Incorrect: Nastaw budzik na 545. </span>
              </p>
              <p className={styles.block_380}>
                <span className={styles.text_23}>Common technical abbreviations</span>
                <span className={styles.text_19}> </span>
              </p>
              ...
              <p className={styles.block_385}>
                <span className={styles.text_23}>Slang terms (spell them out)</span>
                <span className={styles.text_19}> </span>
              </p>
              ...
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
                <span className={styles.text_36}>kilometry na godzinę - km/h </span>
              </p>
              <p className={styles.block_387}>
                <span className={styles.text_23}>Common measurements of area</span>
                <span className={styles.text_19}> </span>
              </p>
              <p className={styles.block_386}>
                <span className={styles.text_35}>● </span>
              ...
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
                <span className={styles.text_36}>stopa kwadratowa - ft² </span>
              </p>
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
              ...
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
                <span className={styles.text_36}>centymetr kwadratowy - cm² </span>
              </p>
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
              ...
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
                <span className={styles.text_36}>kilometr kwadratowy - km² </span>
              </p>
              <p className={styles.block_20}>
                <span className={styles.text_35}>● </span>
              ...
              <p className={styles.block_387}>
                <span className={styles.text_23}>Common scientific terms</span>
                <span className={styles.text_19}> </span>
              </p>
              <p className={styles.block_386}>
                <span className={styles.text_35}>● </span>
              ...
              <p className={styles.block_392}>
                <span className={styles.text_}>Date and time</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_394}>
                <span className={styles.text_21}>Correct: 5 października 2015 </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_397}>
                <span className={styles.text_21}>Correct: 1 marca 2015 r. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_398}>
                <span className={styles.text_21}>Correct: 1 III 2015 r. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
                    pierwszy marca dwa tysiące piętnastego roku
              ...
              <p className={styles.block_399}>
                ...
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>lata dziewięćdziesiąte </span>
                <span className={styles.text_31}>" </span>
                <span className={styles.text_21}>Correct: lata dwudzieste </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>lata dwudzieste </span>
                <span className={styles.text_31}>" </span>
              </p>
              <p className={styles.block_400}>
                <span className={styles.text_21}>Correct: środa, 28 stycznia </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>środa dwudziesty ósmy stycznia </span>
                </span>
                <span className={styles.text_31}>" </span>
              </p>
              <p className={styles.block_367}>
              ...
              <p className={styles.block_401}>
                ...
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
                    data ważności jest do siódmy dwunasty dwa tysiące piętnaście
                  </span>
                </span>
                <span className={styles.text_31}>"</span>
              </p>
              ...
              <p className={styles.block_404}>
                <span className={styles.text_19}>Example audio: " </span>
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>data ważności jest do </span>
                </span>
              </p>
              ...
              <p className={styles.block_408}>
                ...
                <span className={styles.text_31}>" </span>
                <span className={styles.text_21}>Correct: Nastaw budzik na 4:00. </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>nastaw budzik na czwartą </span>
                <span className={styles.text_31}>" </span>
                <span className={styles.text_21}>Correct: 1:45 </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>pierwsza czterdzieści pięć </span>
                <span className={styles.text_31}>" </span>
                <span className={styles.text_21}>Correct: około 8 wieczorem </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_410}>
                ...
                <span className={styles.text_31}>" </span>
                <span className={styles.text_21}>Correct: 1 po południu </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_415}>
                <span className={styles.text_27}>Incorrect: o 12 w nocy </span>
                <span className={styles.text_28}>Address</span>
                <span className={styles.text_29}> </span>
              </p>
              ...
              <p className={styles.block_331}>
                <span className={styles.text_23}>Use commas for ENTITY, LOCATION.</span>
                <span className={styles.text_19}> </span>
              </p>
              <p className={styles.block_418}>Correct: dr Nowak, Kraków</p>
              <p className={styles.block_139}>Correct: McDonald's, Warszawa</p>
              <p className={styles.block_139}>Correct: sklep monopolowy, Wrocław</p>
              ...
              <p className={styles.block_421}>Correct: Mieszkam na południu Polski.</p>
              <p className={styles.block_139}>
                <span className={styles.calibre2}>
              ...
              <p className={styles.block_422}>
                <span className={styles.text_}>Web</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_424}>
                <span className={styles.text_21}>Correct: www.google.pl </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>w w w kropka google kropka p l </span>
                </span>
                <span className={styles.text_31}>" </span>
              </p>
              <p className={styles.block_425}>
                ...
                <span className={styles.text_31}>" </span>
                <span className={styles.text_21}>Correct: jacek@interia.pl </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>jacek małpa interia kropka p l </span>
                <span className={styles.text_31}>" </span>
              </p>
              ...
              <p className={styles.block_427}>
                <span className={styles.text_21}>Correct: http:\google.pl </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_338}>
                ...
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>w w kropka onet kropka p l </span>
                <span className={styles.text_31}>" </span>
              </p>
              ...
              <p className={styles.block_192}>
                <span className={styles.text_21}>Correct: www.interia.pl </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>w w w interia kropka p l </span>
                <span className={styles.text_31}>" </span>
              </p>
              ...
              <p className={styles.block_435}>
                <span className={styles.text_21}>Correct: www.pudelek.pl </span>
                <span className={styles.text_31}>Example audio: " </span>
                <span className={styles.text_32}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_436}>
                <span className={styles.text_}>Abbreviation</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_447}>
                <span className={styles.calibre2}>
                  Explanation: "dyrektorem" and "prezydenta" are not abbreviated
                  because the titles do not appear before a proper name.
                </span>
              </p>
              <p className={styles.block_448}>
                <span className={styles.text_2}>
                  By default, title abbreviations appearing before proper names
                  are not capitalized, unless{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>at the beginning of a sentence.</span>
                <span className={styles.text_3}> </span>
              </p>
              <p className={styles.block_149}>
                <span className={styles.calibre2}>
              ...
              <p className={styles.block_455}>
                <span className={styles.calibre2}>
                  Explanation: "Inż." and "Doc." are capitalized only by virtue
                  of standing at the beginning of a sentence.
                </span>
              </p>
              ...
              <p className={styles.block_457}>
                <span className={styles.text_21}>Correct: Spotkajmy się o g. 17. </span>
                <span className={styles.text_22}>Incorrect: Spotkajmy się o g 17. </span>
              </p>
              ...
              <p className={styles.block_463}>
                <span className={styles.calibre2}>
                  Explanation: The abbreviation consists of the first letter of
                  "godzina", so it is followed by a full stop.
                </span>
              </p>
              ...
              <p className={styles.block_466}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>followed by a full stop.</span>
                <span className={styles.text_3}> </span>
              </p>
              <p className={styles.block_467}>
                <span className={styles.text_21}>Correct: dr Kamiński </span>
                <span className={styles.text_22}>Incorrect: dr. Kamiński </span>
              </p>
              <p className={styles.block_468}>
                <span className={styles.text_21}>Correct: pokój nr 202 </span>
                <span className={styles.text_22}>Incorrect: pokój nr. 202 </span>
              </p>
              <p className={styles.block_284}>
                <span className={styles.text_19}>Example audio: " </span>
              ...
              <p className={styles.block_463}>
                <span className={styles.calibre2}>
                  ...
                  "doktor", is the same as the final letter of its abbreviation,
                  "dr", so the abbreviation is not followed by a full stop.
                </span>
              </p>
              <p className={styles.block_464}>
                <span className={styles.text_19}>Example audio: " </span>
              ...
              <p className={styles.block_471}>
                <span className={styles.calibre2}>
                  its abbreviation, "nr", so the abbreviation is not followed by
                  a full stop.
                </span>
              </p>
              ...
              <p className={styles.block_473}>
                <span className={styles.calibre2}>
                  ...
                  abbreviation, "płk", so the abbreviation is not followed by a
                  full stop.
                </span>
              </p>
              ...
              <p className={styles.block_478}>
                <span className={styles.text_19}>Example audio: " </span>
                <span className={styles.text_20}>
                  <span className={styles.calibre2}>dr nowaka nie ma dziś w biurze </span>
                </span>
                <span className={styles.text_19}>" </span>
              </p>
              <p className={styles.block_479}>
                <span className={styles.calibre2}>
                  ...
                  abbreviation, "dr", so the abbreviation must be followed by a
                  full stop.
                </span>
              </p>
              ...
              <p className={styles.block_481}>
                <span className={styles.calibre2}>
                  ...
                  abbreviation, "nr", so the abbreviation must be followed by a
                  full stop.
                </span>
              </p>
              ...
              <p className={styles.block_484}>
                <span className={styles.calibre2}>
                  ...
                  abbreviation, "płk", so the abbreviation must be followed by a
                  full stop.
                </span>
              </p>
              <p className={styles.block_485}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>doubt, do not abbreviate the title.</span>
                <span className={styles.text_3}> </span>
              </p>
