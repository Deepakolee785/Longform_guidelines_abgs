        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_175}>Punctuation</p>
              ...
              <p className={styles.block_89}>Correct: jak gotować ziemniaki</p>
              ...
              <p className={styles.block_218}>
                <span className={styles.calibre2}>
                  Correct: Z góry dochodziły odgłosy szmerów, pisków, trzasków.
                </span>
              </p>
              ...
              <p className={styles.block_223}>
                <span className={styles.calibre2}>
                  Explanation: Non-restrictive modifier. "Bronisław Komorowski"
                  does not change the core meaning of "prezydent Polski", it
                  just adds additional information about the Polish president.
                </span>
              </p>
              ...
              <p className={styles.block_150}>Incorrect: Pozdrawiam, Alicja</p>
              <p className={styles.block_139}>
              ...
              <p className={styles.block_226}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  sentence. Otherwise, separate it from the rest of the sentence
                  with commas.
                </span>
              </p>
              <p className={styles.block_168}>Correct: Dzień dobry.</p>
              <p className={styles.block_139}>Correct: Dzień dobry, Alicjo.</p>
              <p className={styles.block_139}>
              ...
              <p className={styles.block_228}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: Substantial pause between "dzień dobry" and "Tu
                    Karolina". Treat as separate
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_235}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: Syntactically built as a question, so punctuate
                    as a question regardless of
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_237}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: Rising intonation suggests it is a question, so
                    punctuate as a question regardless
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_239}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: Query has rising intonation, but is most likely
                    a web search rather than a true
                  </span>
                </span>
              </p>
              ...
              <p className={styles.block_242}>
                ...
                <span className={styles.text_28}>Colon and quotation</span>
              ...
              <p className={styles.block_243}>
                ...
                <span className={styles.text_25}> </span>
                <span className={styles.text_26}>Correct: "Spóźnię się". </span>
              </p>
              ...
              <p className={styles.block_251}>
                <span className={styles.text_2}>
                  If the text in quotation marks qualifies as a sentence, do not
              ...
              <p className={styles.block_253}>
                <span className={styles.calibre2}>
                  Explanation: Text in quotation marks qualifies as a sentence.
                  Do not add excess punctuation.
                </span>
              </p>
              ...
              <p className={styles.block_259}>
                <span className={styles.calibre2}>
                  ...
                  quotation marks and omit colon.
                </span>
              </p>
              ...
              <p className={styles.block_189}>
                <span className={styles.calibre2}>
                  Explanation: Do not capitalize "odpoczywać" even though it can
                  stand alone as a sentence in other contexts.
                </span>
              </p>
              ...
              <p className={styles.block_269}>Other symbols</p>
              ...
              <p className={styles.block_90}>Incorrect: lot Warszawa-Chicago</p>
              <p className={styles.block_139}>
              ...
              <p className={styles.block_279}>
                Incorrect: Jak się masz znak zapytania? Incorrect: Jak się masz
                znak zapytania
              </p>
              ...
              <p className={styles.block_283}>
                <span className={styles.text_21}>Correct: {`{myślnik}`} </span>
              ...
              <p className={styles.block_286}>
                <span className={styles.calibre2}>
                  Correct: Wyjeżdżam już kropka Jak długo zajmie mi dojazd znak
                  zapytania
                </span>
              </p>
            </div>
