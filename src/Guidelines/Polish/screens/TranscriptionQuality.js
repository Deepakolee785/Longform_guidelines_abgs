        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_142}>Typo</p>
              ...
              <p className={styles.block_147}>Context error</p>
              ...
              <p className={styles.block_139}>Correct: Jadę jutro nad morze.</p>
              ...
              <p className={styles.block_152}>
                ...
                <span className={styles.text_18}>Added or missing words </span>
              </p>
              ...
              <p className={styles.block_157}>
                <span className={styles.calibre2}>
                  Explanation: Implied currency, add "zł" even though it is not
                  spoken.
                </span>
              </p>
              ...
              <p className={styles.block_160}>Substitution</p>
              ...
              <p className={styles.block_165}>Spacing</p>
              ...
              <p className={styles.block_90}>Incorrect: O której będziesz ?</p>
