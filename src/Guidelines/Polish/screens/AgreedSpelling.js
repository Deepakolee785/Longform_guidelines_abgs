        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              {' '}
              <p className={styles.block_493}>Agreed spelling</p>
              ...
              <p className={styles.block_495}>Spelling out</p>
              ...
              <p className={styles.block_500}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  associated with it, use capital letters (with apostrophes for
                  plurals).
                </span>
                <span className={styles.text_3}> </span>
              </p>
              ...
              <p className={styles.block_501}>
                <span className={styles.text_}>Interjections</span>
              ...
              <p className={styles.block_508}>
                <span className={styles.text_}>Proper names</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_512}>
                <span className={styles.text_2}>
                  If proper names include diacritics or symbols uncommon in your
                  language (č, ü, ß, etc),{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_514}>
                <span className={styles.calibre2}>
                  Correct: Małgosia Zaremba została jedną z najlepszych uczennic
                  w szkole.
                </span>
              </p>
              ...
              <p className={styles.block_522}>
                ...
                <span className={styles.text_22}>Incorrect: BURGER KING </span>
              </p>
              ...
              <p className={styles.block_527}>
                <span className={styles.text_2}>
                  Capitalize names of brands if they refer to the brand/company
                  itself. Do not capitalize if{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  the name refers to the product. This distinction follows from
                  the fact that, in the former{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  case, the name of the brand functions as a proper name, and in
                  the latter, it functions as{' '}
                </span>
                <span className={styles.text_3}> </span>
              ...
              <p className={styles.block_528}>
                <span className={styles.calibre2}>
                  Correct: Moje dziecko najbardziej lubi pieluchy marki Pampers.
                </span>
              </p>
              ...
              <p className={styles.block_535}>
                <span className={styles.calibre2}>
                  Explanation: The word "pampersy" is not capitalized because it
                  refers to the product itself and functions as a common name.
                </span>
              </p>
              ...
              <p className={styles.block_520}>
                <span className={styles.text_}>Media title</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_541}>
                ...
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  media title punctuation trumps sentence level punctuation when
                  in conflict. If a popular{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_544}>
                <span className={styles.text_21}>Correct: Transformers 2 </span>
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
              ...
              <p className={styles.block_547}>
                <span className={styles.calibre2}>
                  Incorrect: YouTube ważne są tylko te Dni, których jeszcze nie
                  znamy.
                </span>
              </p>
              <p className={styles.block_548}>
                <span className={styles.calibre2}>
                  Explanation: The speaker is quoting lyrics that just happen to
                  contain the title, Dni, których jeszcze nie znamy. Format as
                  full sentence.
                </span>
              </p>
              ...
              <p className={styles.block_520}>
                <span className={styles.text_}>Multiple spellings</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_467}>
                ...
                <span className={styles.text_22}>Incorrect: Zaraz będę. </span>
              </p>
              ...
              <p className={styles.block_556}>
                <span className={styles.text_21}>Correct: Kocham ciebie. </span>
                <span className={styles.text_31}>Example audio: " </span>
              ...
              <p className={styles.block_564}>articulated and easy to spell.</p>
              <p className={styles.block_565}>
                <span className={styles.text_2}>
                  If you hear a word that does not sound like a standard word of
                  your language because it{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
                  appears to be nonsense, first perform a Google search for the
                  word. If there is a clear{' '}
                </span>
                <span className={styles.text_3}> </span>
                <span className={styles.text_2}>
              ...
              <p className={styles.block_566}>
                ...
                <span className={styles.text_22}>
                  <span className={styles.calibre2}>
                    Explanation: User says "Sanjay Gupta". This might sound like
                    nonsense at first, but the
                  </span>
                </span>
              </p>
