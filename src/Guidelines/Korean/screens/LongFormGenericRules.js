            ...
            <div className="content text">
              ...
              <div id="pii">
                ...
                <p className={styles.block_167}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>CREDIT_CARD_NUMBER </span>
                </p>
                <p className={styles.block_168}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>EMAIL </span>
                </p>
                <p className={styles.block_169}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>PHONE_NUMBER </span>
                </p>
                ...
                <p className={styles.block_171}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>DRIVER_LICENSE_NUMBER </span>
                </p>
                ...
                <p className={styles.block_173}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>SOCIAL_SECURITY_NUMBER </span>
                </p>
                <p className={styles.block_174}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>PASSPORT </span>
                </p>
                ...
                <p className={styles.block_189}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>MEDICARE_NUMBER </span>
                </p>
                ...
                <p className={styles.block_197}>
                  <span className={styles.text_3}>• </span>
                  <span className={styles.text_2}>TAXPAYER_REFERENCE </span>
                </p>
