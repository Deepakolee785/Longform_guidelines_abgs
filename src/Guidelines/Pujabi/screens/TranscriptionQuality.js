        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_221}>Context error</p>
              ...
              <p className={styles.block_230}>Added or missing words</p>
              ...
              <p className={styles.block_240}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਇਕ ਸਮਸ ਲਈ ਪਜਾਹ ਬਹਤ ਿਜਆਦਾ </span>
              </p>
              ...
              <p className={styles.block_264}>Correct: ਮ ਸਬਜੀ ਵਾਲ ਕਲ ਜਾਣਾ ਹ।</p>
              <p className={styles.block_265}>Incorrect: ਮ ਫਲ ਵਾਲ ਕਲ ਜਾਣਾ ਹ।</p>
