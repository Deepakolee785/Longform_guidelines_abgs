            ...
            <div className="content text">
              ...
              <div id="fragment-vrsus-sentences">
                ...
                <p className={styles.block_382}>
                  ...
                  like the beginning or end of a sentence, leave out
                  punctuation. Note that sentence fragments may be a result of
                  cut-off audio samples.
                </p>
                <p className={styles.block_383}>
                  Correct: ਤਹਾਨ ਕੀ ਲਗਦਾ ਹ? ਇਹ ਐਵ
                </p>
                ...
                <p className={styles.block_429}>
                  ...
                  punctuated as a full sentence. In contrast to a voice action,
                  a web search is a query where the user does not request a
                  specific action that a smartphone can complete. Web searches
                  are more often, but not always, spoken as true fragments.
                </p>
              ...
              <div id="commas">
                ...
                <p className={styles.block_519}>
                  Correct: ਹ , ਮ ਇਹ ਕਮ ਕਰਦਾ ਹ ।
                </p>
                <p className={styles.block_520}>
                  Incorrect: ਹ ਮ ਇਹ ਕਮ ਕਰਦਾ ਹ ।
                </p>
              ...
              <div id="other-symbols">
                ...
                <p className={'text'}>
                  Apart from the Punjabi letters ੳ through ਲ਼, you should not
                  use any other symbol than: 0-9 !@#₹$%^&amp;*()-_+='~""[{}
                  ]\|:;'&lt;&gt;.?/
                </p>
