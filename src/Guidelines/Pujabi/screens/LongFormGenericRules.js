        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_177}>● NAME: First and/or Last name</p>
              ...
              <p className={styles.block_177}>● MRN (medical record number)</p>
              ...
              <p className={styles.block_205}>● FDA_CODE: Prescription drug</p>
              ...
              <p className={styles.block_215}>Correct: Social media handles</p>
            </div>
          </Paper>
        </Grid>
        <Hidden smDown>
