          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_816}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਸਾਨ ਚਾਰ ਕਹੀਆ ਅਤ ਚਦ ਤਸਿਲਆ </span>
              </p>
              ...
              <p className={styles.block_850}>"1,000" ਅਕ 'ਚ ਿਲਿਖਆ ਜਾ ਸਕਦਾ ਹ।</p>
              ...
              <p className={styles.block_769}>
                ਹਾਲ ਿਕ ਇਥ ਨਬਰ ਪਰਾ ਨਹ ਹ, ਇਸਨ ਅਕ 'ਚ ਨਾ ਿਲਖ Incorrect: 7,00,00,002
              </p>
              <p className={styles.block_769}>
              ...
              <p className={styles.block_772}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਜੀਰ ਇਕ ਇਕ ਦ ਿਤਨ ਪਜ ਅਠ ਤਰ </span>
                <span className={styles.text_4}>" </span>
              </p>
              <p className={styles.block_769}>
              ...
              <p className={styles.block_864}>
                ...
                speaker says "ਲਖ", "ਕਰੜ", "ਅਰਬ" or "ਿਬਲੀਅਨ".
              </p>
              ...
              <p className={styles.block_890}>Incorrect: ਦ ਬਟ ਿਤਨ * ਪਜ ਬਟ ਛ</p>
              ...
              <p className={styles.block_918}>Correct: ਸਬ ਦਾ ਪਜ ਬਟ ਸਲਵ ਿਹਸਾ।</p>
              ...
              <p className={styles.block_929}>Incorrect: ਮਨ 12.5 ਪਸਤਕ ਦ ਿਦਓ।</p>
              <p className={styles.block_827}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਮਨ ਬਾਰ ਅਤ ਅਧ ਪਸਤਕ ਦ ਿਦਓ </span>
                <span className={styles.text_4}>" </span>
              </p>
              ...
              <p className={styles.block_931}>
                ...
                <span className={styles.text_19}>ਉਸਨ ਫਾਰਮ ਹਾਊਸ ਸਾਢ ਸਤ ਲਖ </span>
              </p>
              ...
              <p className={styles.block_947}>ਪ ਤੀ ਤ ਨ ਵੀ ਅਖਰ 'ਚ ਹੀ ਿਲਖਣਾ ਹ।</p>
              ...
              <p className={styles.block_774}>Correct: 48559 49504 ਐਕਸਟ ਨ 12</p>
              ...
              <p className={styles.block_772}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਅਠ ਘਟ ਗਣਾ ਬਾਰ ਰਪਏ ਿਕਨ ਹਏ </span>
                <span className={styles.text_4}>" </span>
              </p>
              <p className={styles.block_769}>
              ...
              <p className={styles.block_968}>Currency and unit</p>
              <p className={styles.block_773}>
              ...
              <p className={styles.block_979}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਪਟਰਲ ਦੀ ਕੀਮਤ ਅਸੀ ਤਕ ਪਹਚ </span>
              </p>
              ...
              <p className={styles.block_986}>ਿਲਖਣਾ ਹ ਅਤ 80 ਨ "ਅਸੀ" ਿਲਖਣਾ ਹ।</p>
              ...
              <p className={styles.block_1000}>ਅਕ 'ਚ ਿਲਖ ਅਤ ਿਫਰ "ਕਿਵਡ" ਿਲਖ।</p>
              ...
              <p className={styles.block_1005}>ਚਾਹੀਦਾ ਹ ਨਾ ਿਕ "$" ਿਨ ਾਨ ਨਾਲ.</p>
              ...
              <p className={styles.block_1012}>
                ...
                <span className={styles.text_8}>Example audio: " </span>
                <span className={styles.text_19}>ਮ ਤਹਾਨ ਰਪਇਆ ਦਣਾ ਹ ਆਹ ਲਓ </span>
              </p>
              ...
              <p className={styles.block_1023}>ਸਬਿਧਤ ਿਚਨ ਦੀ ਵਰਤ ਨਾ ਕੀਤੀ ਜਾਵ।</p>
              ...
              <p className={styles.block_1034}>
                <span className={styles.text_24}>Correct: 100 ਤ 500 ਰਪਏ </span>
                <span className={styles.text_8}>Example audio: " </span>
              ...
              <p className={styles.block_1065}>Incorrect: ਅਜ ਤਾਪਮਾਨ 20° C ਹ।</p>
              ...
              <p className={styles.block_1100}>Correct: ਿਬਲੀ ਦਾ ਭਾਰ 2 kg ਹ।</p>
              <p className={styles.block_1101}>
                Incorrect: ਿਬਲੀ ਦਾ ਭਾਰ ਦ kg ਹ।
              </p>
              <p className={styles.block_1102}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਿਬਲੀ ਦਾ ਭਾਰ ਦ ਿਕਲਗਰਾਮ ਹ </span>
                <span className={styles.text_4}>" </span>
              </p>
              ...
              <p className={styles.block_1107}>Incorrect: ਮ ਇਥ ਛ ਮਹੀਨ ਿਰਹਾ।</p>
              ...
              <p className={styles.block_1111}>
                <span className={styles.text_21}>Correct: ਪਟਰਲ ₹70 L ਹ। </span>
                <span className={styles.text_8}>Example audio: " </span>
              ...
              <p className={styles.block_1115}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਪਜ ਪਤਾਲੀ ਦਾ ਅਲਾਰਮ ਸ ਟ ਕਰ </span>
                <span className={styles.text_4}>" </span>
              </p>
              <p className={styles.block_818}>
              ...
              <p className={styles.block_1118}>Slang terms (spell them out)</p>
              ...
              <p className={styles.block_1136}>Date and time</p>
              <p className={styles.block_1137}>
                ...
                year. Include spaces to separate the day, month and year but not
                commas.
              </p>
              ...
              <p className={styles.block_1151}>Incorrect: 80 ਵ ਦਹਾਕ ਦਾ ਸਗੀਤ</p>
              ...
              <p className={styles.block_1154}>
                <span className={styles.text_24}>Correct: ਬਧਵਾਰ, 6 ਮਾਰਚ </span>
                <span className={styles.text_8}>Example audio: " </span>
              ...
              <p className={styles.block_1164}>ਵਖ ਕਰਨ ਲਈ "/" ਦੀ ਵਰਤ ਕਰਨੀ ਹ।</p>
              ...
              <p className={styles.block_770}>ਹਨ। ਇਸ ਕਰਕ ਿਤਨ ਪਦਰ ਨ 3:15 ਿਲਖ।</p>
              <p className={styles.block_966}>
                <span className={styles.text_22}>Correct: 3:15 </span>
                <span className={styles.text_8}>Example audio: " </span>
              ...
              <p className={styles.block_1180}>ਵਜ" ਵੀ ਹਦਾ ਹ। ਇਸਨ ਬਦ 'ਚ ਿਲਖ।</p>
              ...
              <p className={styles.block_1184}>Address</p>
              ...
              <p className={styles.block_1190}>
                <span className={styles.text_13}>Correct: ਕਫੀ ਾਪ, 234435 </span>
                <span className={styles.text_14}>
              ...
              <p className={styles.block_1193}>Correct: ਿਪ ਅਕਾ ਗਪਤਾ, ਨਵ ਿਦਲੀ</p>
              ...
              <p className={styles.block_1197}>Correct: ਿਦਲੀ ਯਨੀਵਰਿਸਟੀ, ਿਦਲੀ</p>
              ...
              <p className={styles.block_1204}>Web</p>
              ...
              <p className={styles.block_1212}>ਨ ਕਡਲਦਾਰ ਬਰਕਟ 'ਚ ਿਲਿਖਆ ਿਗਆ ਹ।</p>
              ...
              <p className={styles.block_1216}>
                <span className={styles.text_22}>Correct: http://123.com </span>
                <span className={styles.text_8}>Example audio: " </span>
                <span className={styles.text_19}>
              ...
              <p className={styles.block_1222}>Incorrect: ਮਾਈਕ ਐਟ ਇਗਜ ਪਲ.ਓਰਗ</p>
              ...
              <p className={styles.block_1226}>
                ...
                <span className={styles.text_8}>Example audio: " </span>
                <span className={styles.text_19}>ਅਜ ਮ ਘਰ ਜਾ ਿਰਹਾ ਹ ਹ ਟਗ </span>
              </p>
              ...
              <p className={styles.block_1232}>Correct: #ਜਲਧਰ ਮ ਘਰ ਪਹਚ ਿਗਆ।</p>
              ...
              <p className={styles.block_1242}>
                Do not correct speaker errors such as transcribing a "ਸਲ " when
                the user actually says "ਬਕਸਲ ".
              </p>
              ...
              <p className={styles.block_1248}>
                <span className={styles.text_5}>ਬਕਸਲ ਮਲ ਡਾਟ ਯਾਹ ਡਾਟ ਕਾਮ </span>
                <span className={styles.text_4}>" </span>
              </p>
              ...
              <p className={styles.block_1259}>
                If the speaker drops a "ਡਬਲਯ" or "ਡਾਟ" and it's an obvious URL,
                you should correct these errors. If the speaker doesn't say the
                "ਡਬਲਯ"s at all, do not add them.
              </p>
              ...
              <p className={styles.block_1262}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਡਬਲਯ ਡਬਲਯ ਡਾਟ ਐਮਾਜਾਨ ਡਾਟ </span>
              </p>
              ...
              <p className={styles.block_1271}>
                ...
                <span className={styles.text_8}>Example audio: " </span>
                <span className={styles.text_19}>ਡਬਲਯ ਡਬਲਯ ਫਸਬਕ ਡਾਟ ਕਾਮ </span>
                <span className={styles.text_8}>" </span>
              </p>
              ...
              <p className={styles.block_1278}>
                <span className={styles.text_4}>Example audio: " </span>
                <span className={styles.text_5}>ਡਬਲਯ ਡਬਲਯ ਡਬਲਯ ਡਾਟ ਜੀ ਓ </span>
              </p>
              ...
              <p className={styles.block_1283}>Abbreviation</p>
              ...
              <p className={styles.block_1292}>Correct: ਮ ਡਾ. ਰਮਨ ਨ ਜਾਣਦਾ ਹ</p>
              ...
              <p className={styles.block_1139}>Incorrect: ਭਾ.ਜ.ਪਾ. , ਬ.ਸ.ਪਾ.</p>
