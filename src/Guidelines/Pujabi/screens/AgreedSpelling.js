          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_1324}>
                ...
                names or businesses, for example). This rule does not apply to
                acronyms or initialisms, or to spelled-out web or email
                addresses. If an English word is spelt out, write out the
                letters in latin script and in lower case.
              </p>
              ...
              <p className={styles.block_1340}>
                ...
                <span className={styles.text_8}>Example audio: " </span>
                <span className={styles.text_19}>ਐਮਾਜਾਨ ਡਾਟ ਸੀ ਓ ਡਾਟ ਯ ਕ </span>
                <span className={styles.text_8}>" </span>
              </p>
              ...
              <p className={styles.block_1347}>
                ...
                itself or some other meaning associated with it, use the letter
                itself
              </p>
              <p className={styles.block_1348}>Correct: ਜ ਤ ਰ ਹਣ ਵਾਲ ਅਖਰ</p>
              <p className={styles.block_1349}>Incorrect: "ਜ" ਤ ਰ ਹਣ ਵਾਲ ਅਖਰ</p>
              <p className={styles.block_1350}>Correct: ਤਰਬਜ 'ਚ ਿਕਨ ਤ ਹਨ।</p>
              <p className={styles.block_1351}>Interjections</p>
              ...
              <p className={styles.block_1357}>Incorrect: ਹਾਹਾਹਾ, ਮਨ ਪਤਾ ਹ!</p>
              ...
              <p className={styles.block_1366}>Proper names</p>
              <p className={styles.block_1367}>
                Use official spellings and punctuation for proper names. Google
              ...
              <p className={styles.block_1369}>
                <span className={styles.text_13}>Correct: ਛਣਕਾਟਾ 97 1/2 </span>
              ...
              <p className={styles.block_1375}>
                ...
                formatting of first result. If nothing is found, then search it
                on Wikipedia. If still you found nothing on Wikipedia, just just
                write them in the format in which they are written.
              </p>
              ...
              <p className={styles.block_1433}>Brand and product</p>
              ...
              <p className={styles.block_1457}>
                ...
                spelling of "ਓਕਈ". This spelling is unique to these cases.
              </p>
              ...
              <p className={styles.block_1460}>Incorrect: Okay, Google Now.</p>
              ...
              <p className={styles.block_1518}>Media title</p>
              ...
              <p className={styles.block_1543}>
                Transcribe foreign media titles if they are commonly understood
                by Punjabi speakers. Transcribe all media titles in Gurmukhi
                script.
              </p>
              ...
              <p className={styles.block_1546}>Incorrect: [skip]</p>
              <p className={styles.block_1548}>Multiple spellings</p>
              ...
              <p className={styles.block_1561}>
                Use official spellings for technical terms. Google them and pay
