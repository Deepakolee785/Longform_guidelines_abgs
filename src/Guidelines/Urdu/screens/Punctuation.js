            ...
            <div className="content text">
              ...
              <div id="fragment-vrsus-sentences">
                ...
                <p className={styles.block_314}>
                  ...
                  generally expressed by a trigger (in Urdu most often a noun,
                  or the object of the action to be performed, but it can also
                  be any other part of speech denoting a change of state of the
