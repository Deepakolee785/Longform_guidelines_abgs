            ...
            <div className="content text">
              ...
              <div id="typo">
                ...
                <p className={styles.block_223}>
                  ...
                  <span dir="rtl" className={styles.text_}>
                    ڈر ر​ ​ ​ ، ​" ظ " ​ رد ود​ ​ ​ ​ ​ ڈر ​ ​ روا​ ​ فو ​ ​ ​ ​
                    ودرا
                  </span>
                  <span className={styles.text_}> </span>
                </p>
                <p className={styles.block_224}>
                  <span dir="rtl" className={styles.text_}></span>
                  <span className={styles.text_}> ۔ ​ ​ ​ </span>
                </p>
              ...
              <div id="spacing">
                ...
                <p className={'text'}>
                  ...
                  <span className={styles.text_}>
                    ...
                    there is no need to add even a single space. Whereas when
                    the words end at joining alphabets, then the space must be
                    inserted.
                  </span>
                </p>
