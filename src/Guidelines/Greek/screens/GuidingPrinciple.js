        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="punctuation">
                <p className={styles.block_48}>Punctuation </p>
                ...
                <p className={styles.block_50}>Fragments versus sentences </p>
                ...
                <p className={styles.block_72}>Spoken punctuation </p>
              ...
              <div id="format">
                ...
                <p className={styles.block_78}>Number </p>
