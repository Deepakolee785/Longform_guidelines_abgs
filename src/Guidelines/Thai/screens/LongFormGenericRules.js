        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_135}>Longform generic rules</p>
              ...
              <p className={styles.block_141}>Segmentation</p>
              ...
              <p className={styles.block_146}>Speaker labeling</p>
              <p className={styles.block_138}>
              ...
              <p className={styles.block_149}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_3}>ORRECT</span>
                <span className={styles.text_2}>: pre recorded speaker 1 </span>
              </p>
              <p className={styles.block_150}>
                <span className={styles.text_2}>I</span>
                <span className={styles.text_3}>NCORRECT</span>
                <span className={styles.text_2}>: pre-recorded speaker_1 </span>
              </p>
              ...
              <p className={styles.block_156}>Pii</p>
              <p className={styles.block_142}>
              ...
              <p className={styles.block_159}>• NAME: First and/or Last name</p>
              ...
              <p className={styles.block_171}>• MRN (medical record number)</p>
              ...
              <p className={styles.block_182}>• FDA_CODE: Prescription drug</p>
