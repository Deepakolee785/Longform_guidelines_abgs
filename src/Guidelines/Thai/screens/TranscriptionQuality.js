        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              {' '}
              <p className={styles.block_388}>Transcription quality</p>
              <p className={styles.block_389}>Typo</p>
              ...
              <p className={styles.block_411}>
                ...
                are unsure, please DO research. If not found, you can also check
                what major news publications do. You can compare Google search
                results but don't forget to add the quotation mark to the query
                in order that it can search what you typed exactly. For instance
                if variation A produces 3 million search results but variation B
                produces only 1 million, you might want to opt for variation A.
                If you cannot decide, ask yourself: what would you expect to see
                transcribed if you were writing that audio to your university
                professor? If you cannot find any terms in the glossary (which
                means this is not standardized enough in the culture), you
                should use your best judgement to consider which words should be
                transliterated according to the rules and which can be
                transliterated according to popular usage.
              </p>
              ...
              <p className={styles.block_416}>
                ...
                <span className={styles.text_2}>
                  : Although the word is widely misspelled, please stick on the
                  rules from Royal Institute.
                </span>
              </p>
              ...
              <p className={styles.block_429}>
                Use either Thai or Latin scripts including special characters if
                necessary. If you have to type any special character that is not
                available in a physical keyboard, google it and copy-and-paste
                it. Diacritics are fine as long as they are not too exotic.
              </p>
              ...
              <p className={styles.block_450}>Context error</p>
              ...
              <p className={styles.block_457}>
                <span className={styles.text_2}>I</span>
                <span className={styles.text_3}>NCORRECT</span>
                <span className={styles.text_2}>: you're favorite movie </span>
              </p>
              <p className={styles.block_458}>
                <span className={styles.text_2}>C</span>
                <span className={styles.text_3}>ORRECT</span>
                <span className={styles.text_2}>: You're my best friend. </span>
              </p>
              ...
              <p className={styles.block_474}>Added or missing words</p>
              ...
              <p className={styles.block_488}>
                ...
                <span className={styles.text_3}>ORRECT</span>
                <span className={styles.text_2}>
                  : I really don't think Hey that's a good idea, let's do that!
                </span>
              </p>
              <p className={styles.block_489}>Substitution</p>
              ...
              <p className={styles.block_498}>Spacing</p>
              ...
              <p className={styles.block_509}>
                <span className={styles.text_4}>C</span>
                <span className={styles.text_5}>ORRECT</span>
                <span className={styles.text_6}>: ขอต อนรนบ ดร. สมศนกดสท </span>
              </p>
              ...
              <p className={styles.block_522}>
                ...
                properly. Conjunctions, e.g. แตจ แม วจา กระนน น ดนงนน น แล วจ ง,
              ...
              <p className={styles.block_523}>
                ...
                <span className={styles.text_6}>
                  ...
                  แตจเพราะจสตใจทรจดรงามของเธอ แม วจาจะมรคนรอบตนวฉนนคนดค านกซตาม
                </span>
              </p>
              <p className={styles.block_524}>
                ...
                <span className={styles.text_6}>
                  อ ด.ญ. สบดา ประเสรสฐศรร บ านอย จชลบบรร มรพรจน อง 2 คน ทรจบ าน
                  ทนาอาชรพค าขาย
                </span>
              </p>
              <p className={styles.block_525}>
                Add space for web search or queries that is not in a grammatical
                order.
              </p>
              ...
              <p className={styles.block_529}>
                Space only after a repetition marker (ๆ) and an ellipsis marker
                (ฯ)
              </p>
              ...
              <p className={styles.block_537}>
                <span className={styles.text_8}>C</span>
                <span className={styles.text_9}>ORRECT</span>
                <span className={styles.text_10}>: ตะหลสว หม อ ทนพพร ฯลฯ </span>
                <span className={styles.text_15}>E</span>
                <span className={styles.text_16}>XPLANATION</span>
              ...
              <p className={styles.block_552}>
                ...
                For foreign names from China, Korea, and Vietnam, spacing is NOT
                required unless you feel it is more common to add a space.
              </p>
              ...
              <p className={styles.block_568}>
                <span className={styles.text_4}>I</span>
                <span className={styles.text_5}>NCORRECT</span>
                <span className={styles.text_6}>: พ.ต.อ.ม.ร.ว.ดร._สมชาย </span>
              </p>
              <p className={styles.block_569}>
                <span className={styles.text_4}>I</span>
                <span className={styles.text_5}>NCORRECT</span>
                <span className={styles.text_6}>: พ.ต.อ._ม.ร.ว._ดร.สมชาย </span>
              </p>
