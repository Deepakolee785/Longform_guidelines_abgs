          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_789}>
                ...
                <span className={styles.text_9}>ne demekmiş c o s t c o </span>
                <span className={styles.text_7}>" </span>
              </p>
              ...
              <p className={styles.block_806}>Interjections</p>
              ...
              <p className={styles.block_814}>
                Official format and spelling of a proper name may supersede the
                usual written transcription conventions detailed in this
                document.
              </p>
              ...
              <p className={styles.block_818}>
                ...
                ü, ç, etc), include them in your spelling.
              </p>
              ...
              <p className={styles.block_823}>
                spelling that yields the most Google search hits when you search
                for the name followed by the word
              </p>
              ...
              <p className={styles.block_827}>
                ...
                <span className={styles.text_3}>
                  ...
                  more results than "Sofia name", even though searching "Sofia"
                  yields more results than "Sophia" because Sofia is the capital
                  of Bulgaria.
                </span>
              </p>
              ...
              <p className={styles.block_836}>
                ...
                designate any holiday on its own thus shouldn't be capitalised.
              </p>
              ...
              <p className={styles.block_839}>Brand and product</p>
              ...
              <p className={styles.block_954}>
                <span className={styles.text_}>• </span>
                <span className={styles.text_3}>Samsung Galaxy Note III </span>
              </p>
              ...
              <p className={styles.block_967}>Media title</p>
              ...
              <p className={styles.block_970}>
                which is more likely; if truly unclear, default to media title.
              </p>
              ...
              <p className={styles.block_976}>
                Follow the spelling of the original titles checking on official
                websites
              </p>
              ...
              <p className={styles.block_995}>
                <span className={styles.text_}>• </span>
                <span className={styles.text_3}>MovieSmart Premium 2 HD </span>
              </p>
              ...
              <p className={styles.block_1006}>
                spelling is without punctuation, then don't punctuate the title.
                If an utterance is ambiguous between a media
              </p>
              <p className={styles.block_1007}>
                title and a sentence or web search, use your judgment for which
                is more likely and treat it accordingly.
              </p>
              ...
              <p className={styles.block_1015}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: What Does the Fox Say? </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
              ...
              <p className={styles.block_1029}>Multiple spellings</p>
              ...
              <p className={styles.block_1031}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Pseudotsuga menziesii </span>
              </p>
              <p className={styles.block_848}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
              ...
              <p className={styles.block_1067}>
                there is a small sound change (i.e. accent, speech error, speech
                impairment, etc),
              </p>
              <p className={styles.block_1068}>transcribe the intended word.</p>
              ...
              <p className={styles.block_1078}>
                but it is obviously based on real words, suffixes, or prefixes,
                transcribe as is.
              </p>
              ...
              <p className={styles.block_1080}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Dönpir olsa da yesek. </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
                  : Unsure whether speaker intended to say "kumpir" or "döner",
              ...
              <p className={styles.block_1082}>
                it appears to be nonsense, first perform a Google search for the
                word. If there is a clear candidate,
              </p>
              ...
              <p className={styles.block_1085}>
                like nonsense at first, but the transcriber guesses the spelling
                "jüğ sosu" and is by corrected Google Search to "jü sosu", a
                type of sauce. Transcribe Jü.
              </p>
              ...
              <p className={styles.block_1091}>
                ...
                Unintelligible label as instructed in:
              </p>
              <p className={styles.block_1092}>
                Longform generic rules &gt; Unintelligible or foreign or singing
              </p>
            </div>
          </Paper>
        </Grid>
