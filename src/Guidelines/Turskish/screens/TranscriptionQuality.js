        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_195}>Transcription quality</p>
              <p className={styles.block_196}>
                Comply with the standard rules of the writing system.
              </p>
              <p className={styles.block_197}>Typo</p>
              ...
              <p className={styles.block_201}>
                ...
                <span className={styles.text_3}>: Beni telfonla ararsın. </span>
              </p>
              ...
              <p className={styles.block_216}>Context error</p>
              ...
              <p className={styles.block_220}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The speaker uses function word "şuraya" which should not be
                  used with an apostrophe as if the word is a person name "Şura"
                  inflected with dative case marker "(y)A".
                </span>
              </p>
              ...
              <p className={styles.block_225}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The speaker gives a pause between "yetenek" and "sizsiniz".
                  That is why the words should not be written as one word.
                </span>
              </p>
              <p className={styles.block_226}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Oraya bakıp geleceğim. </span>
              </p>
              ...
              <p className={styles.block_228}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The speaker uses the function word "oraya" which should not
                  be used with an apostrophe as if the word is a person name
                  "Oray" inflected with dative case marker "-A".
                </span>
              </p>
              <p className={styles.block_229}>Added or missing words</p>
              ...
              <p className={styles.block_250}>Substitution</p>
              ...
              <p className={styles.block_257}>Spacing</p>
