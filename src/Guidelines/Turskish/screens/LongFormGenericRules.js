        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_133}>Longform generic rules</p>
              ...
              <p className={styles.block_139}>Segmentation</p>
              ...
              <p className={styles.block_144}>Speaker labeling</p>
              ...
              <p className={styles.block_148}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: pre recorded speaker 1 </span>
              </p>
              <p className={styles.block_149}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_}>NCORRECT</span>
                <span className={styles.text_3}>: pre-recorded speaker_1 </span>
              </p>
              <p className={styles.block_150}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: unidentifiable speaker </span>
              </p>
              ...
              <p className={styles.block_155}>Pii</p>
