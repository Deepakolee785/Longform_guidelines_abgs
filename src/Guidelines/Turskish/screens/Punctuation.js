        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_275}>Punctuation</p>
              ...
              <p className={styles.block_277}>Fragments versus sentences</p>
              ...
              <p className={styles.block_292}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Londra'da hava durumu </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
              ...
              <p className={styles.block_293}>
                ...
                be considered complete sentences
              </p>
              ...
              <p className={styles.block_308}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Haldun Taner oyunları </span>
              </p>
              ...
              <p className={styles.block_327}>
                as well as end of a sentence. In this case, you can use "comma"
                between "ne kadara" and "nerede" as well as a question mark at
              ...
              <p className={styles.block_330}>sentence; the end was cut off.</p>
              ...
              <p className={styles.block_336}>Commas</p>
              ...
              <p className={styles.block_341}>
                ...
                focuses the meaning of a sentence,
              </p>
              ...
              <p className={styles.block_353}>
                ...
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>: postpositional phrase </span>
              </p>
              ...
              <p className={styles.block_356}>
                sentence that follows it, treat that initial word as a separate
                sentence.
              </p>
              ...
              <p className={styles.block_360}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Yok, seni dinliyorum. </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
              ...
              <p className={styles.block_361}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Evet, ben de oradaydım </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
              ...
              <p className={styles.block_373}>
                ...
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>
                  : Amerika cumhurbaşkanı, Barack Obama, zirve toplantısındaydı.
                </span>
              </p>
              <p className={styles.block_374}>
                ...
                <span className={styles.text_3}>
                  ...
                  core meaning of "Amerika cumhurbaşkanı", it just adds
              ...
              <p className={styles.block_376}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : Restrictive modifier. The relative clause "rezervazyon yapan
                  kişiler" restricts which people we are talking about, it
              ...
              <p className={styles.block_377}>
                ...
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>
                  : Cumhurbaşkanı Obama, 2008'de seçilmiş olan, 2009'da törenle
                  göreve getirildi.
                </span>
              </p>
              ...
              <p className={styles.block_385}>
                If a greeting occurs at the beginning of a sentence or fragment,
                place a comma after the greeting.
              </p>
              <p className={styles.block_386}>
                If the greeting includes an addressee, place the comma after the
                addressee.
              </p>
              ...
              <p className={styles.block_393}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Meryem, beni geri ara. </span>
              </p>
              ...
              <p className={styles.block_397}>
                ...
                <span className={styles.text_3}>
                  ...
                  appears to be a shortened version of "Kerim, bu Metin.", so we
                  treat it as a full sentence.
                </span>
              </p>
              ...
              <p className={styles.block_400}>
                When the phrase appears before longer utterances, place a comma
                after "Google".
              </p>
              ...
              <p className={styles.block_405}>Intonation marks</p>
              ...
              <p className={styles.block_422}>
                ...
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>: pleasant neutral tone </span>
              </p>
              ...
              <p className={styles.block_424}>Colon and quotation</p>
              ...
              <p className={styles.block_428}>
                ...
                <span className={styles.text_3}>
                  ...
                  within quotation marks. The word "diyorlar" is amongst common
                  reported speech verbs in Turkish, but other forms of words
                  ("dedi", "söyledi") can be used for reported speech.
                </span>
              </p>
              ...
              <p className={styles.block_432}>
                ...
                <span className={styles.text_3}>
                  ...
                  used for reported speech. There is no need to use "period" at
                  the end of the sentence.
                </span>
              </p>
              ...
              <p className={styles.block_440}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : The "modundaydı" construction introduces a direct quotation,
                  so a comma is needed after "Leyla". Since the quote is in the
                  middle of the sentence, you should use "period" at the end of
                  the sentence.
                </span>
              </p>
              <p className={styles.block_441}>
                In Turkish, we prefer to use quotation marks in quotative voice
                actions even when the quote follows the command. If the quote is
                in the middle of the sentence or the beginning of the sentence,
                you should use punctuation markers for the quote and the rest of
                the sentence.
              </p>
              ...
              <p className={styles.block_449}>
                ...
                <span className={styles.text_3}>
                  ...
                  "question mark" at the end of the sentence since the quote is
              ...
              <p className={styles.block_455}>
                In Turkish, using quotation marks is preferred rather than using
                colons.
              </p>
              ...
              <p className={styles.block_457}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : There is no need to capitalize the first letter in the word
                  "dişçi" since the quoted part is like a fragment.
                </span>
              </p>
              ...
              <p className={styles.block_463}>
                ...
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
                  : It is the beginning of the sentence. Therefore, "Hello" has
                  been written in uppercase "H".
                </span>
              </p>
              <p className={styles.block_363}>
                <span className={styles.text_5}>C</span>
              ...
              <p className={styles.block_464}>should write it in lowercase.</p>
              ...
              <p className={styles.block_466}>
                In Turkish, quotation marks for metalinguistic uses of words or
              ...
              <p className={styles.block_475}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Ayşe'nin annesi geldi. </span>
              </p>
              ...
              <p className={styles.block_478}>Spoken punctuation</p>
