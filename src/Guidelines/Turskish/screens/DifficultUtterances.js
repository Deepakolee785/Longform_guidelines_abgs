        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_1093}>Difficult utterances</p>
              ...
              <p className={styles.block_1095}>Skipping a prompt</p>
              ...
              <p className={styles.block_1098}>Hesitations and truncations</p>
              ...
              <p className={styles.block_1107}>
                ...
                <span className={styles.text_8}>XAMPLE AUDIO</span>
                <span className={styles.text_7}>: " </span>
                <span className={styles.text_9}>tavuk suyuna çorba kaş- </span>
                <span className={styles.text_7}>" </span>
              </p>
              ...
              <p className={styles.block_168}>
                ...
                <span className={styles.text_22}>
                  examples of filler words in the English language. These may or
