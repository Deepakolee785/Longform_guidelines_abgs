          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_511}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_}>NCORRECT</span>
                <span className={styles.text_3}>: 1/4 asfalt tamamlandı. </span>
              </p>
              ...
              <p className={styles.block_525}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: 6,5 aylık hamileymiş. </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
              ...
              <p className={styles.block_526}>
                ...
                out in words. With mixed numbers,
              </p>
              ...
              <p className={styles.block_528}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Bana yarım ekmek ver. </span>
              </p>
              ...
              <p className={styles.block_531}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: elmanın on altıda beşi </span>
              </p>
              ...
              <p className={styles.block_538}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: Yarım ağız gülümsedi. </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
                <span className={styles.text_10}>
              ...
              <p className={styles.block_588}>Currency and unit</p>
              ...
              <p className={styles.block_591}>
                ...
                <span className={styles.text_8}>XAMPLE AUDIO</span>
                <span className={styles.text_7}>: " </span>
                <span className={styles.text_9}>dolar çok değer kazandı </span>
                <span className={styles.text_7}>" </span>
              </p>
              ...
              <p className={styles.block_596}>
                the inflection markers "ın" and "nun". You can keep writing the
              ...
              <p className={styles.block_604}>
                ...
                <span className={styles.text_8}>XAMPLE AUDIO</span>
                <span className={styles.text_7}>: " </span>
                <span className={styles.text_9}>ailem on litre süt aldı </span>
                <span className={styles.text_7}>" </span>
              </p>
              ...
              <p className={styles.block_609}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Domatesler 5 kg geldi. </span>
              </p>
              <p className={styles.block_610}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Burada 6 yıl yaşadım. </span>
              </p>
              ...
              <p className={styles.block_615}>Common technical abbreviations</p>
              ...
              <p className={styles.block_665}>
                ...
                <span className={styles.text_20}>
                  <sub className={styles.calibre1}>Date and time </sub>
                </span>
              </p>
              ...
              <p className={styles.block_671}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: 90'ların unutulmazları </span>
                <span className={styles.text_7}>E</span>
                <span className={styles.text_8}>XAMPLE AUDIO</span>
                <span className={styles.text_7}>: " </span>
                <span className={styles.text_9}>
              ...
              <p className={styles.block_689}>
                ...
                <span className={styles.text_8}>XAMPLE AUDIO</span>
                <span className={styles.text_7}>: " </span>
                <span className={styles.text_9}>saat dört ila beş arası </span>
                <span className={styles.text_7}>" </span>
              </p>
              ...
              <p className={styles.block_694}>Address</p>
              ...
              <p className={styles.block_308}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Burger King, Eskişehir </span>
              </p>
              ...
              <p className={styles.block_212}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: Craigslist, Groningen </span>
              </p>
              ...
              <p className={styles.block_726}>Web</p>
              ...
              <p className={styles.block_747}>
                ...
                <span className={styles.text_}>XPLANATION</span>
                <span className={styles.text_3}>
                  : Although speaker forgets to use the first "dot", you should
                  transcribe "dot".
                </span>
              </p>
              ...
              <p className={styles.block_763}>Abbreviation</p>
              ...
              <p className={styles.block_768}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_}>ORRECT</span>
                <span className={styles.text_3}>: bu ve benzeri durumlar </span>
              </p>
              ...
              <p className={styles.block_774}>
                <span className={styles.text_5}>C</span>
                <span className={styles.text_6}>ORRECT</span>
                <span className={styles.text_5}>: NASA, NATO, YÖK, ODTÜ </span>
                <span className={styles.text_10}>E</span>
                <span className={styles.text_11}>XPLANATION</span>
