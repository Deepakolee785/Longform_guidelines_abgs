        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_746}>Punctuation</p>
              ...
              <p className={styles.block_748}>Fragments versus sentences</p>
              ...
              <p className={styles.block_755}>
                ...
                <span className={styles.text_}>
                  ...
                  still transcribed as a complete sentence.
                </span>
              </p>
              ...
              <p className={styles.block_758}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "பககத ட ைபயன" is not a response to any question and is not a
              ...
              <p className={styles.block_510}>
                ...
                <span className={styles.text_2}>XPLANATION</span>
                <span className={styles.text_}>
                  : The voice action is a complete sentence so it is transcribed
              ...
              <p className={styles.block_798}>
                ...
                <span className={styles.text_14}>: ெசனைன வைரபடதைதக காட . </span>
              ...
              <p className={styles.block_801}>Commas</p>
              ...
              <p className={styles.block_808}>
                ...
                <span className={styles.text_5}>
                  ...
                  pauses, do not use a comma. There are places where commas are
              ...
              <p className={styles.block_817}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "ேநற " is an adverbial and should be separated from the rest
              ...
              <p className={styles.block_677}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "இபப க " is a sign off, so there should be a comma after it.
                  Do not transcribe a period at the end.
                </span>
              </p>
              ...
              <p className={styles.block_848}>
                <span className={styles.text_12}>C</span>
                <span className={styles.text_13}>ORRECT</span>
                <span className={styles.text_14}>: வணககம காரத க, இ ஜானி. </span>
                <span className={styles.text_22}>E</span>
                <span className={styles.text_23}>XPLANATION</span>
              ...
              <p className={styles.block_851}>
                between the greeting and the following sentence, so "வணககம காரத
                க" and "இ ஜானி" are both treated as separate sentences. In cases
                like these, transcribe a period instead of a comma.
              </p>
              ...
              <p className={styles.block_854}>
                addressee so transcribe a comma after it to separate it from the
                sentence.
              </p>
              ...
              <p className={styles.block_858}>
                " ேவக", "வணககம", and "இ லா", so they are separated by commas and
                not periods.
              </p>
              ...
              <p className={styles.block_863}>
                ...
                <span className={styles.text_2}>XPLANATION</span>
                <span className={styles.text_}>
                  : "Ok Google" was spoken in isolation, so do not transcribe it
              ...
              <p className={styles.block_865}>
                phrase "இந யா ன படஙகள", so transcribe a comma after "Ok Google".
              </p>
              ...
              <p className={styles.block_867}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "Ok Google" appears before the command "ெசனைன வைரபடதைதக காட
                  " so transcribe a comma after "Ok Google".
                </span>
              </p>
              <p className={styles.block_868}>Question marks</p>
              ...
              <p className={styles.block_872}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Speaker talks with neutral intonation (ந நிைல ேபசசான ). Even
                  if the intonation does not sound like the intonation of a
                  question, this sentence is structured as a question.
                </span>
              </p>
              ...
              <p className={styles.block_876}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Since the sentence has question intonation (ேகள ேபசசான ), it
                  is transcribed as a question, even though it is not structured
              ...
              <p className={styles.block_878}>
                ...
                so it should be punctuated properly (with
              </p>
              <p className={styles.block_879}>
                commas separating the topics and a question mark at the end).
              </p>
              <p className={styles.block_880}>Colon and quotation</p>
              ...
              <p className={styles.block_882}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Since "ெசானனான" is a verb that reports the exact words of a
                  speaker, quotation marks are used. There is no period within
                  the quotation because the phrase "கட ரியன பாம " is not a
                  complete sentence.
                </span>
              </p>
              ...
              <p className={styles.block_232}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "ந பாவளிக ஊ க வநதாயா?" is a complete question, so transcribe
                  a question mark inside the quotation. Do not transcribe a
                  period after the quotation marks.
                </span>
              </p>
              ...
              <p className={styles.block_343}>
                ...
                <span className={styles.text_5}>
                  ...
                  question mark inside the quotation. Again, do not transcribe a
                  period after the quotation marks.
                </span>
              </p>
              ...
              <p className={styles.block_892}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Even though the statement "சரி." appears in the middle of a
                  larger sentence, final punctuation needs to be transcribed
              ...
              <p className={styles.block_386}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "நான உனைனக காத க ேறன" follows the command "ெமா ெபயரததல", so
                  a colon is used before the phrase without any quotation marks.
                </span>
              </p>
              ...
              <p className={styles.block_907}>Other symbols</p>
              <p className={styles.block_908}>
                Apart from Tamil letters and the Latin letters a through z, you
                should not use any other symbol than:
              ...
              <p className={styles.block_915}>Spoken punctuation</p>
              ...
              <p className={styles.block_929}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : ளாட 4-B is an address with established internal punctuation
                  (4-B), so use the punctuation symbols here, don't type out
                  "ேகா " between curly brackets.
                </span>
              </p>
              ...
              <p className={styles.block_812}>
                ...
                <span className={styles.text_5}>
                  ...
                  So use a "." instead of spelling it out as {`{ ளளி}`}.
                </span>
              </p>
              ...
              <p className={styles.block_962}>
                ...
                <span className={styles.text_5}>
                  ...
                  curly brackets. The speaker does not say "ேகள க " aloud after
                  the question "ந எஙேக இ க றாய" so transcribe it with the
