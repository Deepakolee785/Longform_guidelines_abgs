        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_286}>Difficult utterances</p>
              ...
              <p className={styles.block_376}>Skipping a prompt</p>
              ...
              <p className={styles.block_288}>Things to ignore</p>
              ...
              <p className={styles.block_296}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : இநத வழக ல, ேபசசாளர ேநாககத டன "ஒெஹா" என னார. ஆகயால அைத "ஒெஹா"
                  என ெமா ெபயரத ளள .
                </span>
              </p>
              ...
              <p className={styles.block_311}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : " " ஒ வாரதைத அலலாதல, இநத தவறான ெதாடககதைத ெமா ெபயரகக ேவணடாம.
                </span>
              </p>
              ...
              <p className={styles.block_317}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : கைட ல " " ெவடடபபட ளள . அநத வாரதைத "மா " அலல ேவர எதாவதாக ம இ
                  கக வாயப உளளதால அைத ெமா ெபயரகக ேவணடாம.
                </span>
              </p>
              <p className={styles.block_319}>
              ...
              <p className={styles.block_323}>
                கைள ேசரத எ த ம. "நாம ேபாகேவ" ஒ ைமயான வாக யம அலலாததால இதறக ர ளளி
                ேசரகக டா .
              </p>
              ...
              <p className={styles.block_330}>
                <span className={styles.text_5}>வணககம வணககம வணககம வணககம </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_335}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : ேபசசாளர "இ ற எ ப ேபர" எனறார, ஆனால ைமகேராஃேபானில "இ ஏ " என ப
                  ெசயதார. நஙகள ேகடடைத மட ம எ ஙகள.
                </span>
              </p>
              ...
              <p className={styles.block_339}>
                <span className={styles.text_5}>வாரதைதைய ெசால ஙகள அ ேத ம </span>
                <span className={styles.text_3}>" </span>
              </p>
              <p className={styles.block_340}>
                <span className={styles.text_3}>E</span>
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>: " ரனஹா" வாரதைத சததமாக </span>
              </p>
              <p className={styles.block_341}>
                றபப ற . த ளள ேபச ைறவான சததத ல றபப ற . இநத னனணி உைரைய எ த ேவணடாம.
              </p>
              ...
              <p className={styles.block_360}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : ேபச இரண ேபசசாளரகளின இைடேய நடக ற . இரணைட ம நி ததற கள உபெயா த
                  எ த ம.
                </span>
              </p>
              ...
              <p className={styles.block_364}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : தல ேபசசாளர ேப ெகாண இ க ம ேபாேத இரணடாவ ேபசசாளர ஆமா என க றார.
                  இைத ெமா ெபயரகக ேவணடாம.
                </span>
              </p>
              ...
              <p className={styles.block_370}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : ஒ ேபசசாளர ேப ெகாண க ம ேபாேத, மறெறா ேபசசாளர "இலைல" என க டடார.
                  இநத "இலைல" ைய ெமா ெபயரகக ேவணடாம.
                </span>
              </p>
              ...
              <p className={styles.block_217}>Foreign language</p>
              ...
              <p className={styles.block_219}>English</p>
              ...
              <p className={styles.block_224}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_4}>NCORRECT</span>
                <span className={styles.text_5}>: நான Judi Dench ம ேறன. </span>
              </p>
              ...
              <p className={styles.block_230}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_4}>ORRECT</span>
                <span className={styles.text_5}>: ேயா Facebook இல உளள . </span>
              </p>
              ...
              <p className={styles.block_232}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "Facebook" ஒ ஆங ல நி வனம எனேவ லத ன எ த கைளப பயனப த இைத ஆங லத
                  ல ெமா ெபயரகக ம.
                </span>
              </p>
              ...
              <p className={styles.block_259}>
                If the speaker in the audio says an English texting initialism,
                abbreviation, or acronym, transcribe it in English with
                lowercase letters.
              </p>
              ...
              <p className={styles.block_268}>Other foreign languages</p>
              ...
              <p className={styles.block_277}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : ட ஒ ஜபபானிய வாரதைதயா ம, ஆனால அ த ழ ேப பவரகளால ரிந ெகாளளபப ற
                  . எனேவ இைத த ல ெமா ெபயரகக ம.
                </span>
              </p>
              <p className={styles.block_278}>Accents</p>
