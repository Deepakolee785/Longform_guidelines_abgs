            ...
            <div className="content text">
              ...
              <div id="aggreed-spelling">
                ...
                <p className={styles.block_28}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>Correct: will.i.am </span>
                </p>
                ...
                <p className={styles.block_31}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>Correct: MacDonald </span>
                </p>
                ...
                <p className={styles.block_31}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>Correct: interpretate </span>
                </p>
                <p className={styles.block_44}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>
                ...
                <p className={styles.block_45}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>Correct: Souk Abdali </span>
                </p>
              ...
              <div id="format">
                ...
                <p className={styles.block_89}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>Correct: 2% milk </span>
                </p>
                ...
                <p className={styles.block_89}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>Correct: 5 / 6 ^ 3 </span>
                </p>
                ...
                <p className={styles.block_116}>
                  <span className={styles.text_}>• </span>
                  <span className={styles.text_1}>
                    Example Audio: im so hashtag hungry i could eat a whole
                    pizza
                  </span>
                </p>
