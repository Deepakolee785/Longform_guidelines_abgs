        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_963}>Agreed spelling</p>
              ...
              <p className={styles.block_965}>Spelling out</p>
              ...
              <p className={styles.block_986}>Interjections</p>
              ...
              <p className={styles.block_990}>Proper names</p>
              <p className={styles.block_991}>
                ...
                Tamil names, use the Tamil Wikipedia, for names in other
              ...
              <p className={styles.block_999}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Searching "ரஙகசா ெபயர" (without quotation marks) yields more
                  results than "அரஙகசா ெபயர".
                </span>
              </p>
              ...
              <p className={styles.block_1002}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Searching "சஞசனா ெபயர" (without quotation marks) yields more
                  results than "சஞஜனா ெபயர".
                </span>
              </p>
              ...
              <p className={styles.block_1011}>
                ...
                <span className={styles.text_5}>
                  ...
                  omitted the article " " in the name. It should be transcribed
                  as spoken.
                </span>
              </p>
              ...
              <p className={styles.block_1015}>Brand and product</p>
              ...
              <p className={styles.block_1032}>Media title</p>
              ...
              <p className={styles.block_1036}>
                ...
                <span className={styles.text_}>
                  : Quotation marks are not used to transcribe video game names.
                </span>
              </p>
              ...
              <p className={styles.block_1046}>Multiple spellings</p>
              <p className={styles.block_1047}>
                When multiple spellings are attested, use the first spelling in
                the reference dictionary (Oxford Tamil Dictionary) for your
              ...
              <p className={styles.block_1054}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Do not change the non standard "அநதாணட ேபா" to the standard
                  "அதன அணைட ேபாt".
                </span>
              </p>
              ...
              <p className={styles.block_1060}>
                ...
                <span className={styles.text_5}>
                  ...
                  spelling and should be changed to the standard spelling: "நான
                  ேபாகேவண ம".
                </span>
              </p>
              ...
              <p className={styles.block_1067}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Although "ஞன " is not a standard word in Tamil, it should be
                  transcribed as "ஞன ", and not the standard form " ன ".
                </span>
              </p>
