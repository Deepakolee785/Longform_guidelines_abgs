            ...
            <div className="content text">
              ...
              <p className={styles.block_386}>
                ...
                <span className={styles.text_5}>
                  : Numbers less than 10 should be written out, so the number 2
                  should be written out as "இரண ".
                </span>
              </p>
              <p className={styles.block_387}>
                <span className={styles.text_3}>C</span>
                <span className={styles.text_4}>ORRECT</span>
                <span className={styles.text_5}>: நான 14 வாைழபபழம னேறன. </span>
              </p>
              ...
              <p className={styles.block_390}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Numbers 10 or above use digits. The number 14 should not be
                  written out as "ப னான ", just use the digits "14".
                </span>
              </p>
              ...
              <p className={styles.block_399}>
                ...
                <span className={styles.text_5}>
                  ...
                  uses digits and does not spell out "3.14" as " ன ளளி ஒன நா "
                  because decimal numbers always use digits.
                </span>
              </p>
              ...
              <p className={styles.block_403}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Even though 9 is less than 10, both numbers refer to "தஙக ன"
                  and one of the numbers is 10 or greater so write out both
              ...
              <p className={styles.block_413}>
                If the speaker in the audio says one number followed by " ல யன",
                " ல யன", " ரில யன", "லடசம", "ேகா ", "அர ", or higher, then
                transcribe it as a numeral followed by the word. Otherwise,
                transcribe it as numerals following the rules below.
              </p>
              ...
              <p className={styles.block_416}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Here, the number 7 is followed by a " ல யன" so it should be
                  transcribed as the numeral "7" with the word " ல யன" written
                  out after it.
                </span>
              </p>
              ...
              <p className={styles.block_420}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Here, the number 1 is followed by a "இலடசம" so it should be
                  transcribed as the numeral "1" with the word "இலடசம" written
                  out after it.
                </span>
              </p>
              ...
              <p className={styles.block_424}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Only write out "லடசம" or any higher amount. In this example,
                  "ஓரா ரம" is small enough to be transcribed using digits
                  "1,000".
                </span>
              </p>
              ...
              <p className={styles.block_429}>
                ளளி இரண எட " using digits "2.28" and then write out "ேகா " after
                it.
              </p>
              ...
              <p className={styles.block_431}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Here the number is in lakhs where the number 54 is followed
                  by "இலடசம", but it's further specified, so write out the whole
                  number with numerals as "54,35,729".
                </span>
              </p>
              ...
              <p className={styles.block_441}>
                ...
                <span className={styles.text_5}>
                  ...
                  the Indian numbering system because the speaker said "ேகா "
                  and "லடசம".
                </span>
              </p>
              ...
              <p className={styles.block_446}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "பத ஆ ரம" should be written as "10,000" with a comma before
              ...
              <p className={styles.block_449}>
                ...
                <span className={styles.text_4}>XAMPLE AUDIO</span>
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_5}>அவரக க அைர டடர பால ேவண ம </span>
                <span className={styles.text_3}>" </span>
              </p>
              ...
              <p className={styles.block_461}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "இரணடைர" is a mixed number so write the number and fraction
                  as numerals with slashes.
                </span>
              </p>
              ...
              <p className={styles.block_470}>
                ...
                <span className={styles.text_2}>XPLANATION</span>
                <span className={styles.text_}>
                  : The "half" in this example is used figuratively and does not
                  refer to a math equation or a unit of measurement so write the
                  fraction out.
                </span>
              </p>
              ...
              <p className={styles.block_479}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "இரணடைர" is a mixed number but since it refers to currency,
                  use the standard currency format "₹2.5".
                </span>
              </p>
              ...
              <p className={styles.block_504}>
                ...
                number. Only transcribe a "+" is the speaker says "பளஸ".
              </p>
              ...
              <p className={styles.block_512}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Since the speaker said the country calling code with a "பளஸ"
                  before the number,
                </span>
              </p>
              ...
              <p className={styles.block_534}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_4}>NCORRECT</span>
                <span className={styles.text_5}>: 12 மாமபழஙக ம/3 ஆரஞ க ம </span>
              </p>
              ...
              <p className={styles.block_536}>Currency and unit</p>
              ...
              <p className={styles.block_539}>
                ...
                <span className={styles.text_5}>
                  ...
                  transcribed with the rupee symbol (₹) followed by the currency
                  amount in numerals.
                </span>
              </p>
              ...
              <p className={styles.block_544}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_4}>NCORRECT</span>
                <span className={styles.text_5}>: ெபடேரால ைல 80 ஐ எட ய . </span>
              </p>
              <p className={styles.block_506}>
                <span className={styles.text_3}>E</span>
                <span className={styles.text_4}>XAMPLE AUDIO</span>
              ...
              <p className={styles.block_545}>
                ...
                <span className={styles.text_2}>XPLANATION</span>
                <span className={styles.text_}>
                  : Here the speaker is referring to the price of gasoline so it
                  should also be transcribed with a rupee sign and numerals as
                  "80".
                </span>
              </p>
              ...
              <p className={styles.block_550}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : The speaker makes no mention of rupees, this refers only to
                  paise so transcribe the number as digits followed by the word
                  "ைபசா".
                </span>
              </p>
              ...
              <p className={styles.block_557}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : " ேரா" refers to a foreign currency. Transcribe the numbers
                  as digits "300" and write out the word " ேரா". Don't use the
                  euro symbol.
                </span>
              </p>
              ...
              <p className={styles.block_232}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : The speaker is referring to the rupee and dollar in general
                  with no specific amounts, so write out the words "டாலர" and "
                  பாய".
                </span>
              </p>
              ...
              <p className={styles.block_565}>
                தல 5,000" so write out the numbers as " ன தல ஐந " followed by "ஆ
                ரம பாய" written out.
              </p>
              ...
              <p className={styles.block_583}>Common technical abbreviations</p>
              ...
              <p className={styles.block_602}>For degrees, use the ° symbol.</p>
              ...
              <p className={styles.block_607}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : The speaker explicitly says "ெசல யஸ" here so use the symbol
              ...
              <p className={styles.block_614}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Since " டடர" appears after the number 10, it is abbreviated
              ...
              <p className={styles.block_619}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Even though 2 is less than 10, it should not be written out
                  as "இரண " here since it comes before a unit of measurement "
                  ேலா ராம".
                </span>
              </p>
              ...
              <p className={styles.block_621}>
                ...
                <span className={styles.text_5}>
                  ...
                  as "ஆ " since it comes before a unit of time "மாதஙகள".
                </span>
              </p>
              ...
              <p className={styles.block_623}>
                <span className={styles.text_12}>C</span>
                <span className={styles.text_13}>ORRECT</span>
                <span className={styles.text_14}>: பயணபெபட 20x20x40 ஆ ம </span>
                <span className={styles.text_15}>E</span>
                <span className={styles.text_16}>XAMPLE AUDIO</span>
                <span className={styles.text_15}>: " </span>
              ...
              <p className={styles.block_629}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_4}>NCORRECT</span>
                <span className={styles.text_5}>: 530 மணிக அலாரம ைவகக ம. </span>
              </p>
              ...
              <p className={styles.block_633}>Date and time</p>
              ...
              <p className={styles.block_641}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : There should be a comma between "ஞா " and the month "நவமபர".
                </span>
              </p>
              ...
              <p className={styles.block_654}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_4}>NCORRECT</span>
                <span className={styles.text_5}>: அலாரதைத 4 மணிக ைவகக ம. </span>
              </p>
              <p className={styles.block_655}>
                <span className={styles.text_3}>E</span>
                <span className={styles.text_4}>XAMPLE AUDIO</span>
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_5}>நான மணிக அலாரதைத ைவகக ம </span>
                <span className={styles.text_3}>" </span>
              </p>
              <p className={styles.block_656}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : The speaker says "மணிக " so the number is referring to time
                  and should be transcribed as "4:00"
                </span>
              </p>
              ...
              <p className={styles.block_664}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Do not transcribe "பத ஆக இரண நி டஙகள" using only words if it
                  refers to the time, use the hh:mm format. Here, "பத ஆக இரண நி
                  டஙகள" is equal to "1:50".
                </span>
              </p>
              <p className={styles.block_665}>
                Only write out time words like " றபகல", "காைல", and " றபகல" if
                spoken. Put one space between the time and the word. Do not use
                the abbreviations " .ப" and " .ப".
              </p>
              ...
              <p className={styles.block_669}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Write out the full word " றபகல", and include a space between
                  "11:00" and " றபகல".
                </span>
              </p>
              ...
              <p className={styles.block_673}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : The speaker did not say " றபகல". Do not transcribe the time
                  word if the speaker did not say it in the audio.
                </span>
              </p>
              ...
              <p className={styles.block_680}>Address</p>
              ...
              <p className={styles.block_685}>
                ...
                <span className={styles.text_23}>XPLANATION</span>
                <span className={styles.text_24}>
                  : The speaker is looking for banks within the zip code 600001,
                  so there is a comma in between the entity, "வங " and the
                  location, "600001" .
                </span>
              </p>
              ...
              <p className={styles.block_687}>Web</p>
              ...
              <p className={styles.block_710}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : There shouldn't be punctuation between "#ப " and "எனக " even
              ...
              <p className={styles.block_716}>
                ...
                <span className={styles.text_5}>
                  ...
                  "சாயேகா ", the speaker says " னசாயேகா " here so transcribe it
                  using the backslash symbol "\".
                </span>
              </p>
              <p className={styles.block_717}>
                If the speaker drops a "ட ல " or " ளளி" and it's an obvious URL,
                you should correct these errors. If the speaker doesn't say the
                "ட ல " at all, do not add them.
              </p>
              ...
              <p className={styles.block_720}>
                ...
                <span className={styles.text_4}>XAMPLE AUDIO</span>
                <span className={styles.text_3}>: " </span>
                <span className={styles.text_5}>ட ல ட ல ள ளளி ேகா ளளி இன </span>
                <span className={styles.text_3}>" </span>
              </p>
              <p className={styles.block_721}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : The speaker doesn't say the " ளளி" before " ள" and only says
                  two "ட ல " so add
                </span>
              </p>
              ...
              <p className={styles.block_729}>Abbreviation</p>
              ...
              <p className={styles.block_734}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Even though "எ ராக" can be abbreviated as "எ ர", the speaker
                  used the full word so it is transcribed as "எ ராக".
                </span>
              </p>
              ...
              <p className={styles.block_739}>
                ...
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : Here, the word "ம த வர" comes before the name "ராமசா ையத" so
                  it is abbreviated as " ைனவர."
                </span>
              </p>
              ...
              <p className={styles.block_741}>
                <span className={styles.text_3}>I</span>
                <span className={styles.text_4}>NCORRECT</span>
                <span className={styles.text_5}>: அவர ேபரா ரியர க ணாகரன. </span>
              </p>
              <p className={styles.block_742}>
                <span className={styles.text_3}>E</span>
                <span className={styles.text_4}>XPLANATION</span>
                <span className={styles.text_5}>
                  : "ேபரா ரியர" precedes the name "க ணாகரன", so transcribe it as
                  "ேபரா.".
                </span>
              </p>
