        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.text_5}>Punctuation </p>
              ...
              <p className={styles.block_919}>Fragments versus sentences</p>
              ...
              <p className={styles.block_921}>
                <span className={styles.text_6}>Correct: క ర ఉ ా? ల ర . </span>
              ...
              <p className={styles.block_926}>
                Explanation: కర ల నప ట ఇక డ య ఆ
              </p>
              <p className={styles.block_927}>సమ ా క ఉండటం, ఇం ా అ సహజం ా</p>
              <p className={styles.block_928}>ప ం పద ావటం అల ాయ .</p>
              ...
              <p className={styles.block_930}>
                Explanation: ఇక డ " ర ంట ాడ " ఏ ప శ
              </p>
              <p className={styles.block_931}>
                సమ నం ాదు ఇం ా ప ాక ం క ాదు అందు
              </p>
              <p className={styles.block_932}>ప ాక ం ా ప గణ ంచట దు.</p>
              ...
              <p className={styles.block_935}>
                Explanation: "అబ ", " ", "ఆ ", "ఓహ " ఇ
              </p>
              <p className={styles.block_936}>ఆశ ా ర ాల స న ామ హ ం ప ాక ం ా</p>
              <p className={styles.block_937}>ాడవచు .</p>
              <p className={styles.block_938}>Correct: .</p>
              <p className={styles.block_939}>Incorrect:</p>
              <p className={styles.block_940}>
                Explanation: " ", "హల " వంట పలక ంప ల , "బ "
              </p>
              <p className={styles.block_936}>వంట డ ల ల ఇ ాట స న ామ హ ం</p>
              <p className={styles.block_941}>ప ాక ం ా ాడవచు .</p>
              ...
              <p className={styles.block_946}>
                ...
                <span className={styles.text_23}>
                  <sub className={styles.calibre1}>● ● అమ </sub>
                </span>
              </p>
              ...
              <p className={styles.block_953}>ామ హ ం త ంచ ాదు, ఒక ళ ఇం ష పద</p>
              ...
              <p className={styles.block_982}>Explanation: స ర య అన ప ాక ం.</p>
              ...
              <p className={styles.block_993}>Commas</p>
              ...
              <p className={styles.block_999}>
                Explanation: వక సు ర ా ల ా నప ట అక డ
              </p>
              <p className={styles.block_1000}>ామ ల ట కం . ామ ల ట దగ అవసర న</p>
              <p className={styles.block_1001}>ట ల ఉంట ా ఉ హరణల అ ల వ .</p>
              ...
              <p className={styles.block_1017}>ప క న ామ ఉం . వర ఫ ా ట వదు .</p>
              ...
              <p className={styles.block_1035}>అన మ ాచక ాక ం మ ందు వ ం కనుక</p>
              <p className={styles.block_1036}>తర ాత ామ ట .</p>
              <p className={styles.block_1037}>Question marks</p>
              ...
              <p className={styles.block_1045}>ప శ ా ాయటం జ ం అ ాం కం ా ాక ం</p>
              <p className={styles.block_1046}>ానప ట .</p>
              <p className={styles.block_1047}>
                <span className={styles.text_6}>Correct: గ మ పండ పం ాయ ? </span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_366}>జ ం (ప ల వర ర ం వర ప ా ర కం ).</p>
              <p className={styles.block_1049}>Colon and quotation</p>
              ...
              <p className={styles.block_1053}>Incorrect: త డ అ డ " ల ప ల ."</p>
              ...
              <p className={styles.block_1060}>Correct: ా అ డ "3:00 కల మ ."</p>
              ...
              <p className={styles.block_1063}>ట ష మ ర ల ల పల ఫ ా ట టం జ ం .</p>
              ...
              <p className={styles.block_1083}>Other symbols</p>
              <p className={styles.block_1084}>
                Apart from Telugu letters and the Latin letters a through z, you
              ...
              <p className={styles.block_1091}>Spoken punctuation</p>
              ...
              <p className={styles.block_241}>Correct: ఎల ఉ వ {`{ప ా ర కం}`}</p>
              ...
              <p className={styles.block_687}>
                <span className={styles.text_14}>ల గ ఒకట ండ మ డ ల గ ఐదు </span>
              ...
              <p className={styles.block_687}>
                <span className={styles.text_15}>Example audio: " </span>
                <span className={styles.text_14}>డబ డబ డబ చుక గ గ చుక ా </span>
                <span className={styles.text_15}>" </span>
              </p>
