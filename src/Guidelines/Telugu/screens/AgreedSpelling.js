        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.text_5}>Agreed spelling </p>
              ...
              <p className={styles.block_447}>Spelling out</p>
              ...
              <p className={styles.block_453}>Interjections</p>
              ...
              <p className={styles.block_457}>ఖ మ త ల ల క ం మ డ ార మ త ాయం .</p>
              <p className={styles.block_458}>Proper names</p>
              <p className={styles.block_459}>
                ...
                celebrity names with unique formatting, look it up in Wikipedia.
                For English celebrity names, refer to the Foreign Language
                section.
              </p>
              ...
              <p className={styles.block_470}>Brand and product</p>
              ...
              <p className={styles.block_479}>
                ...
                <span className={styles.text_23}>
                  <sub className={styles.calibre1}>● ల </sub>
                </span>
              </p>
              ...
              <p className={styles.block_487}>Media title</p>
              ...
              <p className={styles.block_502}>Multiple spellings</p>
