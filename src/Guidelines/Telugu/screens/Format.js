        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_560}>Incorrect: తరగ ల 9 మం ర ల ర .</p>
              ...
              <p className={styles.block_567}>ాయ . అందు "పదమ డ " బదుల ా 13 అ</p>
              ...
              <p className={styles.block_576}>"ఆర " ానూ అల 12 సంఖ లల నూ ాయ .</p>
              ...
              <p className={styles.block_591}>
                ...
                య ", "ట య ", or higher, then transcribe as a numeral plus word.
              ...
              <p className={styles.block_607}>Explanation: ఇక డ "ఒక" సంఖ 1 క</p>
              ...
              <p className={styles.block_621}>సంఖ లల ా " ట " ప లల ాయటం జ ం .</p>
              ...
              <p className={styles.block_625}>Explanation: వక మ టల మధ ల క అయ</p>
              <p className={styles.block_626}>అందువలన సంఖ ప ాల దు, ప సంఖ లల</p>
              ...
              <p className={styles.block_636}>10 క తక వ అం ల నప ట ాట మధ ామ ల</p>
              ...
              <p className={styles.block_641}>వర సల నందున ాట అం ల ర పంల ామ ల</p>
              ...
              <p className={styles.block_682}>
                ...
                <span className={styles.text_24}>Incorrect: 2/3 ట మ 5/16 </span>
              </p>
              ...
              <p className={styles.block_690}>Explanation: ఇ శ మ సంఖ అ నప ట</p>
              ...
              <p className={styles.block_695}>Incorrect: ఆ చు హౌసు ₹7 1/2 య</p>
              ...
              <p className={styles.block_705}>Explanation: యన వంట వ నప డ పద</p>
              <p className={styles.block_655}>ర పం ా ాయ లన యమ ను ారం ఇక డ ా</p>
              ...
              <p className={styles.block_716}>Explanation: "ఎ దవ ం " అన ఒక ా</p>
              ...
              <p className={styles.block_723}>
                ...
                number. Only transcribe a "+" is the speaker says "ప ".
              </p>
              ...
              <p className={styles.block_728}>
                <span className={styles.text_6}>Correct: 91 1234 123456 </span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_740}>Correct: Mercedes-Benz CLS450</p>
              ...
              <p className={styles.block_756}>Currency and unit</p>
              ...
              <p className={styles.block_759}>Correct: జనం ₹100 ఖర అవ త ం .</p>
              <p className={styles.block_760}>Incorrect: జనం 100 ఖర అవ త ం .</p>
              ...
              <p className={styles.block_784}>Common technical abbreviations</p>
              ...
              <p className={styles.block_804}>For degrees, use the ° symbol.</p>
              ...
              <p className={styles.block_818}>సం పక ర పంల " " ా ా అం సం ప ా</p>
              ...
              <p className={styles.block_822}>Explanation: 2 అం 10 క న నప ట</p>
              ...
              <p className={styles.block_825}>
                <span className={styles.text_10}>Correct: నక డ 6 లల ను. </span>
                <span className={styles.text_11}>Example audio: " </span>
                <span className={styles.text_12}>నక డ ఆర లల ను </span>
                <span className={styles.text_11}>" </span>
              </p>
              <p className={styles.block_822}>Explanation: 6 అం 10 క న నప ట</p>
              ...
              <p className={styles.block_836}>డల , ఎత ల ల ప త ండటం ఇక డ అం ల</p>
              ...
              <p className={styles.block_849}>Date and time</p>
              ...
              <p className={styles.block_853}>
                <span className={styles.text_15}>Example audio: " </span>
                <span className={styles.text_14}>జనవ ప ండ పం వందల అర ల గ </span>
                <span className={styles.text_15}>" </span>
              </p>
              ...
              <p className={styles.block_683}>Explanation: ఇక డ వక ా అన పదం</p>
              ...
              <p className={styles.block_683}>Explanation: గంటల అన స ా గంటల</p>
              <p className={styles.block_683}>
              ...
              <p className={styles.block_865}>తక వ ండ " వలం ప లల సూ ంచక ం అ</p>
              ...
              <p className={styles.block_876}>Address</p>
              ...
              <p className={styles.block_883}>ాప ల త క త డ . అందు ఆ ర ఇం ా ట</p>
              ...
              <p className={styles.block_889}>Web</p>
              ...
              <p className={styles.block_895}>Correct: http:\mail.yahoo.com</p>
              ...
              <p className={styles.block_900}>ా " అంట మనం బ ా సం తం "\" ా .</p>
              ...
              <p className={styles.block_906}>వలం ండ "డబ " ల ా డ కనుక వ ల న</p>
              ...
              <p className={styles.block_909}>Incorrect: www.t a r g e t.com</p>
              ...
              <p className={styles.block_915}>Abbreviation</p>
