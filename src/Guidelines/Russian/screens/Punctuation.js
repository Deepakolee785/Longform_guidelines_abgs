        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_329}>Punctuation</p>
              ...
              <p className={styles.block_331}>Fragments versus sentences</p>
              ...
              <p className={styles.block_342}>answer to a specific question.</p>
              ...
              <p className={styles.block_361}>
                The words "да" and "нет" should generally be considered complete
                sentences when on their own. This should also apply to words and
                phrases like "конечно", "ещё бы", "ладно", "ни за что", and "ни
                в коем случае" when they are used as synonyms for "да" and
                "нет".
              </p>
              ...
              <p className={styles.block_383}>Incorrect: Мыть щенка в ванне.</p>
              ...
              <p className={styles.block_425}>
                ...
                complete. Web searches are more often, but not always, spoken as
                true fragments.
              </p>
              ...
              <p className={styles.block_436}>Correct: Включить калькулятор.</p>
              ...
              <p className={styles.block_439}>Commas</p>
              ...
              <p className={styles.block_448}>
                ...
                of the sentence. Please note that introductory words/phrases may
                also be found in the middle or at the end of a sentence. See the
                appendix at the end of this subsection for a list of many common
              ...
              <p className={styles.block_477}>
                ...
                <span className={styles.text_7}>Explanation: yes/no word </span>
              </p>
              <p className={styles.block_477}>
              ...
              <p className={styles.block_535}>Correct: Маленький, пушистый,</p>
              <p className={styles.block_536}>симпатичный котёнок замяукал.</p>
              ...
              <p className={styles.block_547}>
                When two or more words or phrases which are alike (e.g. two noun
                phrases or two verbs) are joined by a conjunction (e.g. "а",
                "но", "да") or multiple conjunctions (e.g. "как...так и", "не
                столько...сколько", "хотя...но", "и...и", "то...то", "ни...ни"),
              ...
              <p className={styles.block_557}>замечания, так и комплименты.</p>
              ...
              <p className={styles.block_564}>Correct: Я думаю, что вам надо</p>
              ...
              <p className={styles.block_594}>
                ...
                phrases are ones that contain verb participles such as "читая",
                "смотря", "танцуя", "прочитав", "увидев".)
              </p>
              ...
              <p className={styles.block_657}>Correct: С уважением, Владимир</p>
              ...
              <p className={styles.block_668}>
                Addressees should be separated from the rest of the sentence by
                commas.
              </p>
              ...
              <p className={styles.block_684}>
                Here are some common introductory words and phrases that should
                be set apart with commas. This is not an exhaustive list.
              </p>
              ...
              <p className={styles.block_728}>Intonation marks</p>
              ...
              <p className={styles.block_747}>Colon and quotation</p>
              ...
              <p className={styles.block_760}>
                If the text inside the quotation marks is a sentence that would
                normally end with a period, do not put a period inside the
                quotation marks. If the quotation is at the end of a sentence,
                put the appropriate sentence-final punctuation after the closing
                quotation mark. If the quotation is at the beginning or in the
                middle of a sentence, put a comma and a dash after the closing
                quotation mark.
              </p>
              ...
              <p className={styles.block_780}>
                ...
                the quote. Do not put a period or comma after the closing
                quotation mark. If the quote is in the middle of a sentence, put
                a dash after the closing quotation mark.
              </p>
              ...
              <p className={styles.block_819}>
                ...
                comma. Use syntax, context, and intonation to determine whether
              ...
              <p className={styles.block_879}>Correct: Что значит перепонка?</p>
              ...
              <p className={styles.block_892}>Incorrect: "Анна" - палиндром.</p>
              ...
              <p className={styles.block_896}>"Карл у Клары украл кораллы".</p>
              ...
              <p className={styles.block_898}>
                ...
                <span className={styles.text_7}>
                  Explanation: However, do use quotation marks
                </span>
              </p>
              <p className={styles.block_899}>
                around words and phrases to be translated.
              </p>
              <p className={styles.block_900}>Other symbols</p>
              <p className={styles.block_901}>
                Apart from the Russian letters and the letters a through z, you
              ...
              <p className={styles.block_910}>
                ...
                which functions somewhat like a definition. Such definitions are
                sometimes preceded by the word "это"; in other cases, the word
                "это" could be inserted without changing the meaning. In some
                cases, the hyphen stands in for the verb "есть".
              </p>
              ...
              <p className={styles.block_915}>
                <span className={styles.text_4}>Correct: Кит - не рыба. </span>
                <span className={styles.text_7}>
              ...
              <p className={styles.block_949}>clause, so do not use a dash.</p>
              <p className={styles.block_950}>
                For complete sentences that follow a single word or phrase that
                focuses the meaning of a sentence, put a dash after the single
                word or phrase.
              </p>
              ...
              <p className={styles.block_977}>Correct: Кто-то сидит в пруду.</p>
              ...
              <p className={styles.block_991}>Incorrect: рейс Москва - Париж</p>
              ...
              <p className={styles.block_993}>Correct: Поезд Москва-Щёлково</p>
              ...
              <p className={styles.block_996}>Spoken punctuation</p>
              ...
              <p className={styles.block_1000}>Incorrect: Я иду домой точка</p>
              <p className={styles.block_1001}>Incorrect: Я иду домой точка.</p>
              ...
              <p className={styles.block_1004}>
                <span className={styles.text_}>Example audio: " </span>
                <span className={styles.text_1}>я еду домой запятая буду </span>
              </p>
              ...
              <p className={styles.block_1037}>запятая коза запятая капуста.</p>
              ...
              <p className={styles.block_1004}>
                <span className={styles.text_}>Example audio: " </span>
                <span className={styles.text_1}>тут надо поставить тире </span>
                <span className={styles.text_}>" </span>
              </p>
