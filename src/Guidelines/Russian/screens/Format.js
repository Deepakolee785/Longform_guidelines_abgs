          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="number">
                ...
                <p className={'text'}>
                  Cardinal numbers in the nominative case from 0 to 9 are
                  written out with letters (except when required otherwise by a
                  different rule - see for example Format &gt; Currency and
                  Unit, Format &gt; Date and Time). Use digits for nominative
                  cardinal numbers 10 and above, even if they are coordinated
                  with numbers under 10.
                </p>
                ...
                <p className={styles.block_1067}>
                  Ordinal numbers, as well as cardinal numbers that are not in
                  the nominative case, should be written out with letters if
                  they are less than 100 (unless required otherwise by a
                  different rule - see for example Format &gt; Currency and
                  Unit, Format &gt; Date and Time). Digits should be used for
                  numbers 100 and higher. Never use digits with suffixes, as
                  they are difficult to standardize.
                </p>
                <p className={styles.block_1068}>
                  Correct: двадцатая годовщина
                </p>
                ...
                <p className={styles.block_1088}>
                  When two or more ordinal numbers, or cardinal numbers not in
                  the nominative case, refer to the same noun, and one number is
                  100 or greater, transcribe both using digits.
                </p>
                ...
                <p className={styles.block_1098}>
                  ...
                  "миллион" or "миллиард", transcribe the number using digits
                  and an abbreviation ("млн" for "миллион", "млрд" for
                  "миллиард"). If no number precedes "миллион" or "миллиард",
                  write the full word.
                </p>
                ...
                <p className={styles.block_1138}>
                  For long numbers (4+ digits) indicating quantity, insert
                  periods between blocks of three numbers.
                </p>
                ...
                <p className={styles.block_1175}>
                  For mixed numbers in math and units and measures, use
                  numerals.
                </p>
                ...
                <p className={styles.block_1208}>
                  ...
                  decimals. (See Format &gt; Currency and Unit for more on how
                  to write ruble amounts.)
                </p>
                ...
                <p className={styles.block_343}>
                  <span className={styles.text_4}>
                    Correct: (84545) 1-23-45{' '}
                  </span>
                  <span className={styles.text_5}>Example audio: " </span>
                  <span className={styles.text_6}>
                    восемь сорок пять сорок{' '}
                  </span>
                </p>
              ...
              <div id="currency-and-unit">
                ...
                <p className={styles.block_1309}>
                  ...
                  kopeks, use digits to transcribe it and abbreviate the
                  currency terms ("руб.", "коп.").
                </p>
                ...
                <p className={styles.block_1328}>
                  When a speaker mentions currency without specifying a
                  quantity, spell out the currency word.
                </p>
                ...
                <p className={styles.block_1347}>
                  For degrees, use the ° symbol. Even if the word "градус" is
                  not used, if a number clearly refers to temperature, use the
                  degree symbol.
                </p>
              ...
              <div id="date-and-time">
                ...
                <p className={styles.block_1453}>
                  Dates should be written with digits unless it looks unnatural
                  to do so.
                </p>
                ...
                <p className={styles.block_1516}>
                  For all forms of "полдень" and "полночь", use the written
                  form.
                </p>
                ...
                <p className={styles.block_1328}>
                  Do not abbreviate time measurements, but do treat them as
                  units by using digits before them.
                </p>
              ...
              <div id="address">
                ...
                <p className={styles.block_1551}>
                  ...
                  to what was said and format it as an address.
                </p>
                ...
                <p className={styles.block_1555}>
                  Correct: врач Иванова, Рязань
                </p>
                <p className={styles.block_1556}>
                  <span className={styles.text_4}>
                    Correct: Ozon.ru, Пермь{' '}
                  </span>
                  <span className={styles.text_7}>
                ...
                <p className={styles.block_1571}>
                  Correct: Южный военный округ
                </p>
