            ...
            <div className="content text">
              ...
              <div id="number">
                ...
                <p className={styles.block_558}>
                  Correct: मा ा वग त नऊ मल आहत.
                </p>
                <p className={styles.block_559}>
                  Incorrect: मा ा वग त 9 मल आहत.
                </p>
                ...
                <p className={styles.block_605}>
                  ...
                  "कोटी", "करोड", "अ " or higher, then transcribe it as a
                  numeral followed by the word. Otherwise, transcribe as
                  numerals following the rules below.
                </p>
                ...
                <p className={styles.block_623}>
                  ...
                  the speaker says "लाख", "कोटी", "करोड" or "अ ".
                </p>
                ...
                <p className={styles.block_688}>
                  ...
                  phone number. Only transcribe a "+" if the speaker says " स".
                </p>
              ...
              <div id="currency-and-unit">
                ...
                <p className={styles.block_840}>
                  If a speaker says a number without saying words like स ाकाळच,
                  रा ीच or पहाटचेetc., format it as time if it is obvious that
              ...
              <div id="address">
                ...
                <p className={'text'}>
                  When transcribing addresses, please follow the following
                  format: number, location description general locality, road,
                  specific locality, city zip code country
                </p>
              ...
              <div id="web">
                ...
                <p className={styles.block_935}>
                  If the speaker drops a "w" or "डॉट" and it's an obvious URL,
