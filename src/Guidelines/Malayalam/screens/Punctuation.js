      ...
      <Grid container>
        <Grid sm={12} md={9} item>
            ...
            <div className="content text">
              ...
              <div id="fragment-vrsus-sentences">
                ...
                <p className={styles.block_23}>
                  നീ ആേരാടാണ സംസാരി ു ത? വാതിലിെ സമീപ ു വ ി.
                </p>
                ...
                <p className={styles.block_23}>
                  ര ആളുകൾ സംസാരി ു ു. "വാതിലിെ സമീപ ു വ ി." എ ത സവിേശഷമായ ഒരു
                  േചാദ ിനു മറുപടിയാണ.
                </p>
                <p className={styles.block_23}>വാതിലിെ സമീപ ു വ ി</p>
                <p className={styles.block_23}>
                  ഇത ഒരു വാക മാെണ ഒരു സ ർഭവും വ മാ ു ി ; ഒരു ഫാഗെമ ആയി പരിഗണി ു
                  ു.
                </p>
                <p className={styles.block_32}>
                  <span className={styles.text_}>േപാകുേ ാ നാളെ പാർ ി ? </span>
                ...
                <p className={styles.block_23}>
                  വാക െ േ ാെലയുമു . വാക മായി അടയാളെ ടു ുക.
                </p>
                <p className={styles.block_32}>
                  <span className={styles.text_}>െപ സിെന ട ിൽ കുളി ി ൽമ </span>
                  <span className={styles.text_5}>
                    <sup className={styles.calibre1}>
                      ഒരു അർഥം നൽകു ി , െവബ െസർ േപാെലയു{' '}
                    </sup>
                  </span>
                  <span className={styles.text_}>
                    ഫാഗ്െമ ആയി അടയാളെ ടു ുക.{' '}
                  </span>
                </p>
                ...
                <p className={styles.block_33}>
                  ...
                  <span className={styles.text_4}>
                    <sub className={styles.calibre2}>അേ ാ. വ ാേ പകം </sub>
                  </span>
                </p>
                <p className={styles.block_23}>നമസ്കാരം. അഭിവാദ ം</p>
                <p className={styles.block_31}>
              ...
              <div id="commas">
                ...
                <p className={styles.block_33}>
                  <span className={styles.text_2}>എവിെടയാണ നി ളുെട വീട? N</span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
                    : എവിെടയാണ, നി ളുെട, വീട?{' '}
                  </span>
                </p>
                <p className={styles.block_31}>
                ...
                <p className={styles.block_23}>
                  അെത, ഞാൻ വിചാരി ു നിന കൂ ുകാരുെ .
                </p>
                <p className={styles.block_}>
                  https://speech.google.com/annotation/guidelines/ml_in_test_set/index.html
                  5/19
                ...
                <p className={styles.block_32}>
                  <span className={styles.text_}>ഹഹ, അത കല ി. </span>
                  <span className={styles.text_5}>
                    <sup className={styles.calibre1}>
                ...
                <p className={styles.block_23}>വ ാേ പ ൾ ഉദാഹരണ ളാണ.</p>
                <p className={styles.block_23}>ഉ , ഞാൻ വരും. ഉ /ഇ പദം</p>
                <p className={styles.block_23}>അെത, അത സംഭവി ും. ഉ /ഇ പദം</p>
                <p className={styles.block_23}>
                ...
                <p className={styles.block_7}>Ok Google</p>
                <p className={styles.block_23}>Ok Google, ഇ യുെട ചി ത ൾ</p>
                <p className={styles.block_23}>
                  Ok Google, ഡീനിെ േകാ ാ വിവര ൾ കാണി ു.
                </p>
                <p className={styles.block_23}>
                  Ok Google, ഈ വർഷെ െമേ ാറിൽ ദിനം എ ാണ?
                </p>
              </div>
              <div id="intonation-marks">
                ...
                <p className={styles.block_23}>നിന ഉറ ാേണാ?</p>
                <p className={styles.block_23}>
                  വാക ഘടനാ പകാരം േചാദ മാണ, അതുെകാ സ രേഭദം പരിഗണി ാെത േചാദ മായി
                  തെ വിരാമച മിടുക.
                </p>
                <p className={styles.block_23}>രാവിെല 3:00 േനാ?</p>
                <p className={styles.block_23}>
                  ഉയർ സ രേഭദം േചാദ മാണ നിർേ ശി ു ു, അതുെകാ സ രേഭദം പരിഗണി ാെത
                  േചാദ മായി തെ വിരാമച മിടുക.
                </p>
                <p className={styles.block_}>3/23/2018 ml-IN_TEST_SET</p>
                ...
                <p className={styles.block_35}>അെത! ആേവശേ ാെട സംസാരി ു ു.</p>
                <p className={styles.block_36}>അെത. ആേവശമി ാെത സംസാരി ു ു.</p>
              </div>
              <div id="colon-and-quotation">
                ...
                <p className={styles.block_20}>
                  <span className={styles.text_2}>
                    അവൾ പറ ു, "ന ു അവിെട ക ുമു ാം." N
                  </span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
                    : അവൾ പറ ു, "ന ു അവിെട ക ുമു ാം.".{' '}
                  </span>
                </p>
                <p className={styles.block_21}>
                  <span className={styles.text_2}>
                ...
                <p className={styles.block_21}>
                  <span className={styles.text_2}>
                    അവൻ പറേ ാ, "അവിെട വരാൻ." N
                  </span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
                    : അവൻ പറേ ാ, "അവിെട വരാൻ."?{' '}
                  </span>
                </p>
                <p className={styles.block_16}>
                ...
                <p className={styles.block_37}>
                  ഇത ഫ ിേല വിവർ നം െച ുക: നിന സുഖമാേണാ?
                </p>
                <p className={styles.block_23}>
                ...
                <p className={styles.block_39}>താ ൾ "നിന സുഖമാേണാ?" എ ത</p>
                <p className={styles.block_40}>ഫ ിേല വിവർ നം െച ുക.</p>
                <p className={styles.block_23}>
                  ഉ രണി വാക ിെ മധ ഭാഗ ാണ, അതുെകാ ഭി ിക ഒഴിവാ ി ഉ രണി ചി ം
                  ഉപേയാഗി ുക.
                </p>
                <p className={styles.block_36}>ഫ ഭാഷയിൽ "എനി നിെ</p>
                <p className={styles.block_11}>3/23/2018 ml-IN_TEST_SET</p>
                <p className={styles.block_41}>
                  <span className={styles.text_2}>ഇ മാണ." എ െന പറയും? N</span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
              ...
              <div id="other-symbols">
                ...
                <p className={'text'}>
                  ...
                  <span className={styles.text_8}>ൿ</span>
                  <span className={styles.text_7}>
              ...
              <div id="spoken-punctuation">
                ...
                <p className={styles.block_18}>
                  ...
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>: ശരി... </span>
                </p>
                <p className={styles.block_21}>
                  <span className={styles.text_2}>
          ...
          അടയാളം} `}
                ...
                <p className={styles.block_18}>
                  <span className={styles.text_2}>
                    ഞാൻ താമസി ു ത അ ാർെ മ 10-A യിലാണ. N
                  </span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
                ...
                <p className={styles.block_21}>
                  <span className={styles.text_9}>www.fake-domain.com N</span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
                    : www {`{േഡാ }`} fake {`{തുടർ ുറി} `}domain {`{േഡാ }`} com
                  </span>
                </p>
                <p className={styles.block_36}>അവൾ ഒരു അഭിേന തി/േമാഡൽ ആണ.</p>

                <p className={styles.block_41}>
                  <span className={styles.text_9}>N</span>
                  <span className={styles.text_3}>OT</span>
                  <span className={styles.text_2}>
                ...
                <p className={styles.block_46}>{`{അപൂർ വിരാമം}`}</p>
                <p className={styles.block_36}>{`{അടിവര}`}</p>
              </div>
            </div>
          </Paper>
        </Grid>
