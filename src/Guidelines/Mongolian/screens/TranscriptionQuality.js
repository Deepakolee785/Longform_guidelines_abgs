            ...
            <div className="content text">
              ...
              <div id="typo">
                ...
                <p className={styles.block_220}>
                  ...
                  <span className={styles.text_8}>: Google </span>
                </p>
                <p className={styles.block_221}>
                  ...
                  <span className={styles.text_10}>google </span>
                  <span className={styles.text_2}>" </span>
                </p>
                <p className={styles.block_222}>
                  <span className={styles.text_2}>I</span>
                  <span className={styles.text_3}>NCORRECT</span>
                  <span className={styles.text_2}>: Goggle </span>
                </p>
                <p className={styles.block_222}>
                  <span className={styles.text_2}>I</span>
                  <span className={styles.text_3}>NCORRECT</span>
                  <span className={styles.text_2}>: Goolge </span>
                </p>
                <p className={'text'}>
